...
class Doctor extends CI_Controller
{
    ...
    */
    ...
    function print_solicitud($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/doctor/print_solicitud', $page_data);
    }
    ...
    function print_financial_report($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/doctor/print_finance_reports', $page_data);
    }
    ...
    function print_inventory_report($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/doctor/print_inventory_reports', $data);
    }
 ...
 function update_discount_table_est($stabilitation_id)
    ...
    function combos($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/combos/', 'refresh');
        }
        ...
        if($param1 == 'set')
        {
            ...
            redirect(base_url() . 'doctor/solicitudes/', 'refresh');
        }
    ...
    function purchases($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create_solicitud')
        {
            ...
            redirect(base_url() . 'doctor/purchases/', 'refresh');
        }
    ...
    {
        if($category_id != 0)
            $products = $this->db->query("SELECT product.product_id,product.name FROM product JOIN inventory_product ON product.product_id = inventory_product.product_id JOIN inventory ON inventory.inventory_id = inventory_product.inventory_id WHERE product.status = 1  AND product.category_id = ".$category_id." AND inventory.clinic_id = ".$this->session->userdata('current_clinic'))->result_array();
        else
            $products = $this->db->query("SELECT product.product_id,product.name FROM product JOIN inventory_product ON product.product_id = inventory_product.product_id JOIN inventory ON inventory.inventory_id = inventory_product.inventory_id WHERE  product.status = 1  AND inventory.clinic_id = ".$this->session->userdata('current_clinic'))->result_array();
    ...
    function subcategories($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/subcategories/', 'refresh');
        }
    ...
    function sales($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create_cot')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Venta agregada correctamente.");
            redirect(base_url() . 'doctor/sales/'.base64_encode(1), 'refresh');
        }
        ...
        if($param1 == 'create_sale_insurance')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Venta agregada correctamente.");
            redirect(base_url() . 'doctor/sales_insurance/', 'refresh');
            ...
            {                        
                ...
                <div class="alert alert-white" style="margin-top: 42px;">
                        <span style="display:block;font-weight:bold;font-size:18px;font-family:"Poppins", sans-serif">Detalles de la cita:</span>
                                ...
                                <div class="col-sm-12 row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <b>Peso:(lbs)</b>
                                            <input class="form-control" type="number" step="any" onchange="updateConsulta(\'w\','.$vs['vital_sign_id'].',this.value)" value="'. $vs['w'].'"></input>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <b>Altura:(cm)</b>
                                            <input class="form-control" type="number" step="any" onchange="updateConsulta(\'t\','.$vs['vital_sign_id'].',this.value)" value="'. $vs['t'].'"></input>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <b>IMC:</b>
                                            <input class="form-control" type="number" step="any" onchange="updateConsulta(\'imc\','.$vs['vital_sign_id'].',this.value)" value="'. $vs['imc'].'"></input>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                            ...
                            if($this->check['access_appointments'] == 1)
                                $html .= ' <a class="btn btn-success" href="'.base_url().'doctor/appointment_details/'.$param1.'"><i class="picons-thin-icon-thin-0133_arrow_right_next"></i> Ingresar a la cita</a>';
                            ...
                            <br>
                               ...
                               <div class="col-sm-12 row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <b>Peso:(lbs)</b>
                                        <input class="form-control" type="number" step="any" onchange="updateConsulta(\'w\','.$vs.',this.value)" value="'. $vs['w'].'"></input>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <b>Altura:(cm)</b>
                                        <input class="form-control" type="number" step="any" onchange="updateConsulta(\'t\','.$vs.',this.value)" value="'. $vs['t'].'"></input>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <b>IMC:</b>
                                        <input class="form-control" type="number" step="any" onchange="updateConsulta(\'imc\','.$vs.',this.value)" value="'. $vs['imc'].'"></input>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <b>PA:</b>
                                        <input class="form-control" type="number" step="any" onchange="updateConsulta(\'pa\','.$vs.',this.value)" value="'. $vs['pa'].'"></input>
                                    </div>
                                </div>
                               <div class="col-sm-12">
                                   <div class="form-group">
            ...
            <div class="alert alert-white" style="margin-top: 42px;">
                    <span style="display:block;font-weight:bold;font-size:18px;font-family:"Poppins", sans-serif">Detalles de la cita:</span>
                        ...
                        <div class="pipeline-item">
                           ...
                           if($this->check['access_appointments'] == 1)  
                                $html .= ' <a class="btn btn-success" href="'.base_url().'doctor/appointment_details/'.base64_encode($param1).'"><i class="picons-thin-icon-thin-0133_arrow_right_next"></i> Ingresar a la cita</a>';
 ...
 public function stabilitation($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url() . 'doctor/stabilitation/', 'refresh');
        }
    ...
    function patients($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/patient_profile/'.$patient_id, 'refresh');
        }
        if($param1 == 'update')
        {
    ...
    function memberships($param1 = '') {
        ...
        if($param1 == 'create_membership')
        {
            ...
            redirect(base_url().'doctor/memberships', 'refresh');
        }
    ...
    function points($param1 = '') {
        ...
        if($param1 == 'set')
        {
            ...
            redirect(base_url().'doctor/points', 'refresh');
        }
    ...
    function admins($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'doctor_auth_link'){
            $this->security_model->updateSecret(base64_decode($param2));
            $this->session->set_flashdata('flash_message' , "Autenticación activada correctamente.");
            redirect(base_url() . 'doctor/admin_security/'.base64_encode($param2), 'refresh');
        }
        ...
        if($param1 == 'update_doctor_modules')
        {
            $this->accounts_model->update_doctor_modules($param2);
            $this->session->set_flashdata('flash_message' , "Datos actualizados correctamente.");
            redirect(base_url() . 'doctor/admin_permissions/'.base64_encode($param2).'/', 'refresh');
        }
        ...
        if($param1 == 'delete')
        {
            ...
            redirect(base_url() . 'doctor/admins/', 'refresh');
        }
    ...
    function permission_request($param1 = '',$param2 = '')
    {
        ...
        if($param1 == 'create'){
            ...
            redirect(base_url() . 'doctor/permission_request/', 'refresh');
    ...
    function staff($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'new')
        {
            ...
            redirect(base_url() . 'doctor/receptionist/', 'refresh');
            
            if($this->input->post('category') == 3)
            redirect(base_url() . 'doctor/providers/', 'refresh');
            
            if($this->input->post('category') == 4)
            redirect(base_url() . 'doctor/sellers/', 'refresh');
            
            if($this->input->post('category') == 5)
            redirect(base_url() . 'doctor/accountants/', 'refresh');
    ...
    function rooms($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/rooms/', 'refresh');
        }
    ...
    function surgery_room($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/surgery_room/', 'refresh');
        }
   ...
   function laboratory($param1 = '', $param2 = '')
   {
    $this->session_login();
       ...
       if($param1 == "create")
       {
           ...
           if($response == 1)
           {
               redirect(base_url().'doctor/laboratory/', 'refresh'); 
           }
       }
       if($param1 == "update")
       {
  ...
  function laboratory_results($param1 = '', $param2 = '')
  {
      ...
      if($param1 == "save")
      {
            ...
            redirect(base_url().'doctor/samples/' , 'refresh');
      ...
      $this->load->view('backend/index', $page_data);
        ...
        function samples($param1 = '', $param2 = '', $param3 = '')
        {
            ...
            if($param1 == "edit")
            {
                ...
                if($response == 1)
                {
                    redirect(base_url().'doctor/samples/'.base64_encode($this->input->post('category_id')), 'refresh');
                }
            ...
            if($param1 == "delivery")
            {
                ...
                if($response == 1)
                {
                    redirect(base_url().'doctor/samples/'.base64_encode(1), 'refresh');
                }
            }
        ...
        function  getPatients($param1= ''){
             ...
             function getDiagnostico(){
                ...
                foreach($samples->result_array() as $sa){
                    ...
                    if($sa['report'] != ""){
                    $html.='     <td>
                                <a href="'.base_url().'doctor/sample_diagnostic/'.base64_encode($sa['sample_id']).'" target="_blank">
  ...
  //////////////////////////////////////////
    function rayos_x($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Laboratorio agregado correctamente.");
            redirect(base_url() . 'doctor/rayos_x/', 'refresh');
        }
    ...
    function product_estb($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Laboratorio agregado correctamente.");
            redirect(base_url() . 'doctor/product_estb/', 'refresh');
        }
    ...
    */
        ...
        foreach($query->result_array() as $row)
        {
            ...
            $html_table .= '
                <tr style="font-size:14px;" class="">
                    ...
                    <td> <a href="'.base_url().'doctor/history/'.$row['product_id'].'" style="color:black;">'.$row['name'].' </a></td>
                    <td>'.$row['code'].'</td>
    ...
    function kardex($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'add_medicamento')
        {
            ...
            redirect(base_url() . 'doctor/history/'.$param2, 'refresh');
        }
    ...
    function equipment($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'doctor/equipment/', 'refresh');
        }
    ...
    function supplies($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Equipo agregado correctamente.");
            redirect(base_url() . 'doctor/supplies/', 'refresh');
        }
    ...
    function entry_staff($param1 = '', $param2 = '')
    {
        ...
        redirect(base_url().'doctor/entry_view/'. $timestamp,'refresh');  
    ...
    function roles($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/roles/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function nomenclature($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'doctor/nomenclature/', 'refresh');
        }
    ...
    function departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'doctor/departure_edit/'.base64_encode($response), 'refresh');
        }
        if ($param1 == 'edit') {
            $response = $this->crud_model->editDeparture();
            $this->session->set_flashdata('flash_message' , "Partida editada exitosamente");
            redirect(base_url().'doctor/departures/', 'refresh');
        }
    ...
    function bank_conciliation($param1 = '', $param2 = '') 
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'doctor/bank_conciliation_detail/'.base64_encode($id), 'refresh');
        }
    ...
    function cash_flow($param1 = '', $param2 = '') 
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'doctor/cash_flow_detail/'.base64_encode($id), 'refresh');
        }
    ...
    function closing_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'doctor/closing/', 'refresh');
        }
    ...
    function opening_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'doctor/opening/', 'refresh');
        }
    ...
    function adjust_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', "Partida de cierre creada correctamente");
            redirect(base_url().'doctor/adjust/', 'refresh');
        }
    ...
    function banks($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/banks/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_accounts($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/bank_accounts/'.$param2, 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function currencies($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/currencies/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_checks($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/bank_checks/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_transfers($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/bank_transfers/', 'refresh');
        }
    ...
    function account_types($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'doctor/account_types/', 'refresh');
        }
        if ($param1 == 'edit') {

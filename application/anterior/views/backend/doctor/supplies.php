    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>doctor/supplies/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0172_structure_menu_submenu_navigation"></i></div>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/supplies'; ?>",
            type: "POST"
        },
...
<div class="modal" id="1new_product">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/supplies/create" method="POST" enctype="multipart/form-data">
...
function delete_supplies(product_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/supplies/delete/" + product_id;
        }
    })
}
</script>
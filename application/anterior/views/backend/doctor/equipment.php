    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>doctor/equipment/">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header"><br>
                <h3 class="module-title">INVENTARIO DE EQUIPO MEDICO</h3>
                <a class="add-buton pull-right" href="javascript:void(0);" data-toggle="modal" data-target="#1new_product">+ Nuevo Equipo</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card-b">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/equipment'; ?>",
            type: "POST"
        },
...
<div class="modal" id="1new_product">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/equipment/create" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
function delete_equipment(product_id) {
    Swal.fire({
        title: '¿Estás seguro?',
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/equipment/delete/" + product_id;
        }
    })
}
</script>
...
<div class="todo-app-w">
    <form action="<?php echo base_url();?>doctor/patients/update/<?php echo $details['patient_id']?>" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="col-xl-11 col-lg-11 col-sm-12" style="float: none; margin: 0 auto;">
                            <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="card">Departamento<?php echo $details['dpto']?></label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group m-b-15">
                                            ...
                                            <input style="border: 1px solid #198cff8f;" type="number" name="n_nacional" class="form-control" value="<?php echo $details['n_nacional']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group m-b-15">
                                            ...
                                            <input style="border: 1px solid #198cff8f;" type="number" name="n_extranjero" class="form-control" value="<?php echo $details['n_extranjero']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>

                                                                ...
                                                                <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                                    ...
                                                                    <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                        <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                            <input name="weight" type="number" id="ember2531" class="form-control ember-view" <?php if ($details['status'] == 4): ?>
                                                ...
                                                <div class="_element_8x0tfa">
                                                    <div class="_field_8x0tfa">
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    <input name="water" type="number" id="ember2536" class="form-control ember-view" 
                                                ...
                                                <div class="_element_8x0tfa">
                                                    <div class="_field_8x0tfa">
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    <input name="grease" type="number" id="ember2541" class="form-control ember-view" 
                                                ...
                                                <div class="_element_8x0tfa">
                                                    <div class="_field_8x0tfa">
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    <input name="muscle" type="number" id="ember2546" class="form-control ember-view" 
                                                ...
                                                <div class="_element_8x0tfa">
                                                    <div class="_field_8x0tfa">
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    <input name="waist" type="number" id="ember2551" class="form-control ember-view" 
                                                ...
                                                <div class="_element_8x0tfa">
                                                    <div class="_field_8x0tfa">
                                                        <div class="_vital-sign-row_c5jvwj _vital-sign-row_184cp7 ">
                                                            ...
                                                            <div class="_vital-sign-data_c5jvwj _vital-sign-data_184cp7">
                                                                <div class="_vital-sign-data-value_c5jvwj _vital-sign-data-value_184cp7">
                                                                    <input name="abdomen" type="number" id="ember2556" class="form-control ember-view" 

                    ...
                    <div class="card-widget">
                        ...
                        <ul class="services_more">
                            <?php $prod = $this->db->limit(8)->order_by('product_id','DESC')->get('product')->result_array();
                                    foreach($prod as $res):?>
                            <a href="<?php echo base_url(); ?>doctor/history/<?php  echo $res['product_id'];?>">
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Todos los productos</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_inventory_report/all">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel_inventory_report/all">EXCEL</a>
                        `);
        }
    });
}
...
function alert_table(card) {
    ...
    $.ajax({
        url: '<?php echo base_url();?>doctor/alert_table/',
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos en alerta</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_inventory_report/alert">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel_inventory_report/alert">EXCEL</a>
                        `);
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos vencidos</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_inventory_report/expirate">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel_inventory_report/expirate">EXCEL</a>
                        `);
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos por vencer</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_inventory_report/per_expirate">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel_inventory_report/per_expirate">EXCEL</a>
                        `);
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos agotados</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_inventory_report/out">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel_inventory_report/out">EXCEL</a>
                        `);
        }
    });
}

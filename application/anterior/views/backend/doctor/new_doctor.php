...
<div class="todo-app-w">
    <div class="todo-content" style="margin-bottom: 8%;">
        <form action="<?php echo base_url();?>doctor/doctors/new" method="POST" enctype="multipart/form-data" id="doc_form">
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-b-15">
                                ...
                                <input style="border: 1px solid #198cff8f;" type="text" name="academic_title" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group m-b-15">
                                <label for="simpleinput">Lugar de estudios</label>
                                <input style="border: 1px solid #198cff8f;" type="text" name="place_study" class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group m-b-15">
                                ...
                                <div class="input-group date datepicker" id="DoctorPicker3">
                                    <input type="text" id="applyDate" name="date_title" autocomplete="off" style="border: 1px solid #198cff8f;" value="" class="form-control">
                                    <span style="display: none;" class="input-group-addon"><i data-feather="calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group m-b-15">
                                ...
                                <div class="input-group date datepicker" id="DoctorPicker4">
                                    <input type="text" id="applyDate" name="date_last_confront" autocomplete="off" style="border: 1px solid #198cff8f;" value="" class="form-control">
                                    <span style="display: none;" class="input-group-addon"><i data-feather="calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group m-b-15">
                                ...
                                <textarea type="text" style="border: 1px solid #198cff8f;" rows="3" name="comments" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group date-time-picker m-b-15">
                                ...
                                <div class="input-group date datepicker" id="DoctorPicker8">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group date-time-picker m-b-15">
                                ...
                                <div class="input-group date datepicker" id="DoctorPicker9">
                ...
                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-4">
                            <div class="row">
                                <div class="col-sm-12">
                                    <label for="simpleinput">Título(s) académico(s):</label>
...
/* document.getElementById('apply').onchange = function() {
    ...
    $(document).ready(function() {
        ...
        fileUpCollege = $('input[name="doc_college"]').fileuploader({
            // Options will go here
            maxSize: 50,
            enableApi: true,
            captions: {
    ...
    $("#doc_form").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                window.location.href='<?php echo base_url(); ?>doctor/doctors';
            },

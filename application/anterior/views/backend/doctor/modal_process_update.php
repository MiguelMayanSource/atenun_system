    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/thooth_procedures/update/<?php echo $row['process_id'];?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="container">
                            ...
                            <small>* Las ganancias establecidas en <b>Financiero</b> serán calculadas automáticamente mediante el <b>Costo</b> que ingreses en cada procedimiento.</small>
                        </div>
                    </div>
                </div>

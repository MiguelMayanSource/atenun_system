                ...
                <div class="card-b">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link <?php if($type == 'year') echo "active";?>" href="<?php echo base_url().'doctor/adjust/year';?>">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                <span class="d-none d-sm-block">Anual</span> 
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link <?php if($type == 'month') echo "active";?>" href="<?php echo base_url().'doctor/adjust/month';?>">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <div class="">
                                    <a class="btn btn-info" href="<?php echo base_url();?>doctor/adjust_departure/">
                                ...
                                <table id="datatable-buttons" class="table table-bordered nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="<?php echo base_url()."doctor/adjust_detail/".base64_encode($ad['adjust_id']);?>"><i class="bx bx-detail"></i></a>
                                                &nbsp;
                                                &nbsp;
    ...
    function eliminarCierre(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/adjust/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

        ...
        <div id="sticky_left">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters" method="POST" action="<?php echo base_url();?>doctor/soon">
                                <div class="form-group date-time-picker m-b-15">
                                    <div class="input-group date datepicker" id="DoctorPicker1" style="border:0px;">
                                        <input type="text" id="applyDate" name="date" autocomplete="off" style="font-weight: 500;padding: 20px;background: #dcdcdc;border-radius: 9px;" value="<?php if($filter) echo $apply; else echo date('d/m/Y', strtotime("+1 day"));?>" class="form-control">
                            ...
                            <ul class="tasks-list">
                                <?php
                                    ...
                                    if($filter){
                                        ...
                                        $appointments =  $this->crud_model->appointment_today_doc($doctor_id,date('d/m/Y', strtotime("+1 day")),$clinic_id, $querys)->result_array();
                                    }

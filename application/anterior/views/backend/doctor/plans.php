        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>doctor/points';">
                        Ver</div>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>doctor/memberships';">
                        Ver</div>
                </div>
            </div>
        </div>

...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="<?php echo base_url();?>doctor/purchasing/" id="frm">
                                <div class="row">
                                    <div class="col-lg-6">
        ...
        <form method="POST" action="<?php echo base_url();?>doctor/printFormType/purchasing/" id="frmP" target="">
...
<script type="text/javascript">
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>doctor/setChecksPurchase/",
            data: {
                vals: vals,
            },
            dataType: "json",

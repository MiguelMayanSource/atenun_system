    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card-widget">
                ...
                <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/print_financial_report/<?php echo base64_encode($fecha1);?>/<?php echo base64_encode($fecha2);?>">IMPRIMIR</a>
                <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>doctor/excel/<?php echo base64_encode($fecha1);?>/<?php echo base64_encode($fecha2);?>">EXCEL</a>
                <span class="app-divider2"></span>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/financial_reports/'.base64_encode($fecha1).'/'.base64_encode($fecha2); ?>",
            type: "POST"
        },

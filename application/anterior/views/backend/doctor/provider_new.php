...
<div id="main-content">
    <div class="todo-content conts">
        ...
        <form action="<?php echo base_url();?>doctor/providers/new_single/" method="POST" enctype="multipart/form-data" id="formS">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-sm-12" style="float: none; margin: 0 auto;">
                    <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                        <div class="row">
        ...
        <form action="<?php echo base_url();?>doctor/providers/new_legal/" method="POST" enctype="multipart/form-data" id="formL" style="display:none;">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-sm-12" style="float: none; margin: 0 auto;">
                    <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                        <div class="row">
...
$("#formS").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $(".loading").remove();
            window.location.replace("<?php echo base_url();?>doctor/providers/");
        },

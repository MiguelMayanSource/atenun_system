...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            ...
                            <form class="repeater" action="<?php echo base_url();?>doctor/balances/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-5">
        ...
        <form method="POST" action="<?php echo base_url();?>doctor/printFormType/balances" id="frmB" target="">

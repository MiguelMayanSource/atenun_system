        ...
        <div class="card-widget br-6">
            ...
            ?>
                <div class="row newField">
                    ...
                    <div class="col-sm-12 col-md-2">
                        <div class="form-group m-b-15">
                            <label for="simpleinput">Precio Especial</label>
                            <input type="text" class=" form-control" id="price_esp">
                            <small></small>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 ">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="row_position">
                            ...
                            <tr class="rows" id="<?php echo $field['laboratory_fields_id']?>">
                                ...
                                <td style="width:250px"><?php echo $field['name'].$laboratory_id; ?></td>
                                ...
                                <?php    if($lab_type == 1): ?>
                                <td style="white-space:nowrap;width:200px">Q.<?php echo $field['price']?></td>
                                <td style="white-space:nowrap;width:200px">Q.<?php echo $field['price_esp']?></td>
                                <?php endif;?>
                                <td>
                            ...
                            <tr id="edit_<?php echo $field['laboratory_fields_id']?>" style="display:none;">
                                ...
                                <td style="white-space:nowrap;width:200px"><input type="text" class=" form-control" id="price_<?php echo $field['laboratory_fields_id']?>" value="<?php echo $field['price']?>"></td>
                                <td style="white-space:nowrap;width:200px"><input type="text" class=" form-control" id="price_esp_<?php echo $field['laboratory_fields_id']?>" value="<?php echo $field['price_esp']?>"></td>
                                <td>
...
function addField() {
    ...
    if (laboratory_fields_id != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>doctor/laboratory_fields/add",
            type: 'post',
            data: {
...
function addNewField() {
    ...
    if (name != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>doctor/laboratory_fields/new_field",
            type: 'post',
            data: {
                laboratory_id: laboratory_id,
                name: name,
...
function saveField(field_id) {
    ...
    if (name != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>doctor/laboratory_fields/edit",
            type: 'post',
            data: {
                field_id: field_id,
                name: name,
...
function deleteField(field_id) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>doctor/laboratory_fields/delete/" + field_id,
        type: 'post',
        data: {
            field_id: field_id,
        },
...
function deleteFieldTemplate(laboratory_template_id) {
    console.log('eliminado');
    $.ajax({
        url: "<?php echo base_url();?>doctor/laboratory_fields/delete_field/" + laboratory_template_id,
        type: 'post',
        data: {

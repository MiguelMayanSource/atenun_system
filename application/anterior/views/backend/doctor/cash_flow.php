...
<div id="main-content">
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <div class="card-b">
                    <a class="btn btn-info" style="float: right;" href="<?php echo base_url();?>doctor/cash_flows/">
                    ...
                    <form action="<?php echo base_url();?>doctor/cash_flow/save/" method="POST" id="frmC" target="">
...
<script type="text/javascript">
    ...
    function getUtility() {
        ...
        if (initial != '' && final != '') {
            $.ajax({
                type: "POST",
                url: "<?php  echo base_url();?>doctor/getUtilityStatement/",
                data: {
                    initial: initial,
                    final: final,
                },

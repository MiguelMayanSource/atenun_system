<div class="modal-content animated fadeInDown">
    <form id="formNewPat" action="<?php echo base_url();?>doctor/stabilitation/finish/<?php echo $param2;?>" method="POST" enctype="multipart/form-data">
        <div class="modal-header" style="background-color:#fff;box-shadow: 0 4px 2px -2px 000;">
            <h4 style="font-size:21px; color:#565b6b; font-family:'Poppins';"><span style="vertical-align:-3px"> <i class="batch-icon-user-2-add"></i> Agregar nuevo turno.</span></h4>
        ...
        <div class="modal-body" style="background-color:#fff;">
            <div class="col-xl-12 col-lg-12 col-sm-12" style="float: none; margin: 0 auto;">
                ...
                <h4 class="todo-content-header">
                    <i class="batch-icon-arrow-right"></i><span>Encargado</span>
                </h4>
                <br>
                <div class="row">

...
<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="carnet" >
                <div class="azul" style="cursor:pointer" onclick="window.location='<?php echo base_url();?>doctor/doctor_profile/<?php echo base64_encode($row['admin_id']);?>';">
                    <img src="<?php echo base_url(); ?>public/assets/images/back.png" style="width:100%;height:120px">
                </div>
                <center>
                    <div class="cls" style="cursor:pointer" onclick="window.location='<?php echo base_url();?>doctor/doctor_profile/<?php echo base64_encode($row['admin_id']);?>';">
                        <img src="<?php echo $this->accounts_model->get_photo('admin', $row['admin_id']);?>" class="image">
                    </div>
                </center>
                <div class="inside" style="cursor:pointer" onclick="window.location='<?php echo base_url();?>doctor/doctor_profile/<?php echo base64_encode($row['admin_id']);?>';">
                    <center>
                        <div class="celeste">

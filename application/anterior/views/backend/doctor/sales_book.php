...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="<?php echo base_url();?>doctor/sales_book/">
                                <div class="row">
        ...
        <form method="POST" action="<?php echo base_url();?>doctor/printFormType/sales_book/" id="frmS" target="_blank">
...
<script type="text/javascript">
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>doctor/setChecksSales/",
            data: {
                vals: vals,
            },
            dataType: "json",

                        ...
                        <div class="col-lg-6">
                            <div class="mb-3" style="float: right;">
                                <div class="btn-group focus-btn-group">
                                    <a class="btn btn-info" href="<?php echo base_url();?>doctor/closing/">
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="row">
                                        <div class="col-lg-<?php echo $l;?> mb-3">
                                            ...
                                            <h4>
                                                <?php if($close['category'] == "sales_cost") echo "Costo de ventas";
                                                    elseif($close['category'] == "final_inventory") echo "Inventario final";
                                                    elseif($close['category'] == "profit_loss") echo "Pérdidas y Ganancias";
                                                    elseif($close['category'] == "gross_sales") echo "Ventas brutas";
                                                    elseif($close['category'] == "profit_account") { 
                                                        echo "Contabilización de la ";
                                                        if($dep['total'] >= 0) echo "ganancia";
                                                        else echo "pérdida";
                                                    }
                                                    elseif($close['category'] == "equity_accounts") echo "Cierre cuentas patrimoniales";

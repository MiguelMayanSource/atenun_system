        ...
        <div id="sticky_left">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form method="POST" action="<?php echo base_url();?>doctor/appointments">
            ...
            <div class="col-sm-12">
                <div class="alert alert-info">
                    ...
                    <span class="alert-content">En esta sección podrás visualizar todas las citas que han sido
                        programadas por tu equipo de trabajo, recuerda que puedes agendar una nueva haciendo clic <span class="alert-lined"><a href="<?php echo base_url();?>doctor/appointment/" style="color:#0044e9">aquí</a>.</span></span>
                </div>
            </div>
            <div class="col-sm-7">
...
function appointment_details(appointment_id) {
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>doctor/vital_signs_card/' + appointment_id,
        dataType: "html",
        error: function(xhr, ajaxOptions, thrownError) {
            alert("Ups! Algo salio mal.");
        },
...
function appointment_new_vital_sign(appointment_id) {
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>doctor/new_vital_signs_card/' + appointment_id,
        dataType: "html",
        error: function(xhr, ajaxOptions, thrownError) {
            alert("Ups! Algo salio mal.");
        },
...
function updateConsulta(cl, _id, text) {
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>doctor/patient_app",
        type: "post",
        data: {
            'cl': cl,
            'id': _id,

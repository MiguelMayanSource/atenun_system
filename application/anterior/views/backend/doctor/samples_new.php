        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form action="<?php echo base_url().'doctor/samples/create/'.$param2;?>" method="post" enctype="multipart/form-data" id='formSample'>
                        <div class='row'>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                ...
                                <select name="payment_type" class='form-control ' id="payment_type" onchange="getPrice2()">
                                    <option value="0" selected>Atenun</option>
                                                ...
                                                <td>
                                                    <div class="" style="width:230px;">
                                                        ...
                                                        <select onchange="laboratoriesExamns(this.value,0)" class="form-control basic labs" name="laboratories[]" id="laboratories_0">
                                                            ...
                                                            foreach($db as $info):
                                                        ?>
                                                            <option value="<?php echo $info['product_id'];?>"><?php echo $info['name']?></option>
                                                            <?php endforeach;?>
                                                        </select>
                                                    </div>
                                                </td>
                            ...
                            <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                                <div class="form-group">
                                    ...
                                    <a style='Float:right; display:none' href="<?php echo base_url(); ?>doctor/samples_new" class="btn btn-warning sample_new">Nueva orden</a>

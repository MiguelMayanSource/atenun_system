...
<div id="main-content">
    ...
    <form action="<?php echo base_url();?>doctor/appointments/pay_1/<?php echo $_id; ?>" method="POST">
        <?php endif;?>
        
        <?php if($details['status']==10):?>
    <form action="<?php echo base_url();?>doctor/appointments/pay_2/<?php echo $_id; ?>" method="POST">
        <?php endif;?>
...
function getLaboratories() {
    $.ajax({
        url: '<?php echo base_url();?>doctor/labStatus/' + <?php echo base64_decode($id_);?>,
        success: function(response) {
            if (response != "")
...
function labStatus(exam) {
    $.ajax({
        url: '<?php echo base_url();?>doctor/samples/pay_exam/' + exam,
        success: function(response) 
        {
            getLaboratories()
        },
...
function rayStatus(exam) {
    $.ajax({
        url: '<?php echo base_url();?>doctor/rayx/pay_exam/' + exam,
        success: function(response) 
        {
            getRayos()
        }
...
function getRayos() {
    $.ajax({
        url: '<?php echo base_url();?>doctor/rayx/get_service/' + <?php echo base64_decode($id_);?>,
        success: function(response) {

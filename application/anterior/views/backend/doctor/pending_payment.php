        ...
        <div id="sticky_left">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form method="POST" action="<?php echo base_url();?>doctor/pending_payment">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters" method="POST" action="<?php echo base_url();?>doctor/pending_payment">
                            ...
                            <table class="table">
				                ...
				                ?>
                                    <tr style="font-family:'Poppins';font-size:14px;" class="">
                                        <td>
                                            <a href="<?php echo base_url(); ?>doctor/patient_profile/<?php echo base64_encode($pt['patient_id']); ?>">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-info">
                    ...
                    <span class="alert-content">En esta sección podrás visualizar todas las citas que han sido programadas por tu equipo de trabajo, recuerda que puedes agendar una nueva haciendo clic <span class="alert-lined"><a href="<?php echo base_url();?>doctor/appointment/" style="color:#0044e9">aquí</a>.</span></span>
                </div>
            </div>
            <div class="col-sm-7">
                        ...
                        <div class="tasks-list-w">
                            <ul class="tasks-list">
                                <?php
                                    ...
                                    if($filter){
                                        $appointments =  $this->crud_model->appointment_pendding_doc($doctor_id,$apply,$clinic_id, $querys)->result_array();
                                    }else{
                                        $appointments =  $this->crud_model->appointment_pendding_doc($doctor_id,date('d/m/Y'),$clinic_id, $querys)->result_array();
                                    }
                                ...
                                <div class="alert alert-<?php echo $className;?>">
                                    ...
                                    <div class="pi-controls">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="<?php echo base_url();?>doctor/pay_appointment/<?php echo base64_encode($appointment['appointment_id']);?>">Cobrar</a>

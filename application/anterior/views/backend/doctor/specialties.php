        ...
        <div class="os-tabs-w">
            <div class="os-tabs-controls">
                <ul class="navx nav-tabs">
                    ...
                    <?php endif;?>
                    <li class="nav-item text-center">
                        <a class="nav-link current" href="<?php echo base_url();?>doctor/specialties/">
            ...
            <div class="card-b">
                <div class="container-fluid">
                    <div class="alert alert-info">
                        ...
                        <span class="alert-content">Aquí podrás gestionar y asociar tus especialidades y las de tus <span class="alert-lined"><a href="<?php echo base_url();?>doctor/doctors/" style="color:#0044e9">colegas</a>.</span></span>
                    </div>
                </div>
                <div class="row">
    ...
    <div class="modal" id="1specialtiesModal">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content animated fadeInDown">
                <form action="<?php echo base_url();?>doctor/specialties/create" method="POST">
...
function delete_specialtie(specialtie_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/specialties/delete/" + specialtie_id;
        }
    })
}
    </script>
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="<?php echo base_url();?>doctor/bank_checks/">
                                <div class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &nbsp;&nbsp;
                                                <a class="btn btn-info" href="<?php echo base_url().'doctor/printPDF/check/'.base64_encode($ck['bank_check_id']);?>" target="_blank">
    ...
    function anularCheque(id,no,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/bank_checks/cancel/",
                    data: {
                        id: id,
                    },
                    dataType: "json",
    ...
    function eliminarCheque(id,no,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/bank_checks/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form action="<?php echo base_url() . 'doctor/patient_service_add/create/' . $param2; ?>" method="post" enctype="multipart/form-data" id='formSample'>
                                                    ...
                                                    <div class="" style="width:230px;">
                                                        ...
                                                        <select onchange="laboratoriesExamns(this.value,0)" class="form-control basic labs" name="laboratories[]" id="laboratories_0">
                                                            ...
                                                            <?php
                                                                ...
                                                                $db = $this->db->query('SELECT * FROM `subcategory` where category_id = '.$category_id)->result_array();
                                                                foreach ($db as $info):
                                                                ?>

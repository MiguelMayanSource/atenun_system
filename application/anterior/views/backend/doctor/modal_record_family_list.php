...
input[type=radio]:checked:after {
	...
	<div class="modal-content animated fadeInDown" style="border-radius:20px;">
        ...
        if (count($dats) == 0){
        ?>
	    <form id="formRF" action="<?php echo base_url();?>doctor/patients/create_recordfamily/<?php echo $param2;?>" method="post">
	        <?php }
        
        else {
        ?>
	        <form id="formRF" action="<?php echo base_url();?>doctor/patients/update_recordfamily/<?php echo $param2;?>" method="post">
	            <?php } ?>

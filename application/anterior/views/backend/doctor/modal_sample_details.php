...
<form action="<?php echo base_url();?>doctor/samples/delivery/<?php echo $param2; ?>" method="post" enctype="multipart/form-data" id='formGroup'>
                        ...
                        <div class="form-group">
                            ...
                            <div class='' style='display: inline-flex;'>
                                <?php 
                                            ...
                                            if($row['status'] >0 )
                                            {
                                                $acciones.='<a  style="color: black;font-size: 22px;padding: 12px;" title="Informe" target="_blanck" href="'.base_url().'doctor/laboratory_results/download/'.base64_encode($row['sample_id']).'" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg></a>';
                                                $acciones.='<a  style="color: black;font-size: 22px;padding: 12px;" title="Informe" target="_blanck" href="'.base_url().'doctor/laboratory_results/print/'.base64_encode($row['sample_id']).'" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>';
                                            }
                                            if($row['status_delivery'] == 0 ){

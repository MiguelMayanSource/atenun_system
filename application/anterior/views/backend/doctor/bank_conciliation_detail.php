...
<div id="main-content">
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <div class="card-b">
                    <a class="btn btn-info" style="float: right;" href="<?php echo base_url();?>doctor/bank_conciliations/">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="<?php echo base_url();?>doctor/bank_conciliation/" method="POST">
                                <div class="row">
                                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <form action="<?php echo base_url();?>doctor/printFormType/conciliation/" method="POST" id="frmC" target="">

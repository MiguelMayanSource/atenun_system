<div class="modal-content animated fadeInDown">
    <form action="<?php echo base_url();?>admin/nomenclature/save/" method="POST">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="code" id="code" required onblur="searchNomenNew(this.value)"/>
...
<script type="text/javascript">
    ...
    function searchNomenNew(code) {
        if (code != ""){
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/searchNomenNew/",
                data: {
                    code: code,
                },
                beforeSend: function () {

...
<<div id="main-content">
    <div class="card-widget">
        ...
        <div class="content-box">
            ...
            <div class="card-h">
                <h2 class="card-caption"> <a href="<?php echo base_url();?>admin/surveys/questions/<?php echo $codigo?>"><i class="picons-thin-icon-thin-0159_arrow_back_left"></i></a>
            ...
            <div class="tasks-list-w">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form action="<?php echo base_url();?>admin/update_multiple/update/<?php echo $codigo;?>" method="post">
                                <div class="row">
                                    <div class="col-sm-10">

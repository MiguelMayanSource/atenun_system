        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>admin/whatsapp/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0317_send_post_paper_plane"></i></div> <span>Enviar whatsapp</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/send_email/">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                <div class="card-b">
                    <form action="<?php echo base_url();?>admin/send_email/send" method="POST" enctype="multipart/form-data" id="formWhatsapp">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="middles">
                                    <label>

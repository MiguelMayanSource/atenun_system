...
<div id="main-content">
    ...
    <form action="<?php echo base_url();?>admin/sales/create_sale" method="POST" id="sales_form" onsubmit="return validateForm()">
                ...
                <div class="order-box">
                    ...
                    <div class="order-items-table">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-ms-12 mb-2 row">
                                        <div class="col-lg-6 col-md-6 col-ms-12 mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-check form-check-right mb-1">
                                                        <input class="form-check-input" type="radio" name="ctype_id" id="ctype_id_1" value="0" checked />
                                                        <label class="form-check-label" for="ctype_id_1">Atenun</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-check form-check-right mb-1">
                                                        <input class="form-check-input" type="radio" name="ctype_id" id="ctype_id_2" value="1" />
                                        ...
                                        <div class="col-lg-6 col-md-6 col-ms-12 mb-2">
                                            <div class="" id="insurances" style="display:none;">
                                                <div class="col-form-label">Seguro:</div>
                                                <select name="insurance_id" class="form-control" >
                                                    <?php
                                                        $insurances = $this->db->get_where('insurance',array('status'=>1))->result_array();
                        ...
                        <div class="col-sm-12" style="margin-top: 15px;display: flex;text-align: right;justify-content: right;">
                            <h3 id="" class="order-summary-value grand_total"><?php echo $currency.number_format($details['charges']+$lab_total,'2','.',',');?></h3>
                        </div>
                        <div class="col-sm-12" style="margin-top: 15px;">
                                        ...
                                        <div class="order-foot" id="methods">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-12 mb-2" id="divCash_0" style="">
                                                    ...
                                                    <div class="">
                                                        <label for="" class="col-form-label">Total:</label><br>
                                                        <h2 class="grand_total"></h2>
                                                    </div>
                                                    <div class="">
                                                        <label for="" class="col-form-label">Recibido:</label><br>
                                                        <input name="cambio" id="cambio" class="form-control" type="number" step="any" onchange="findCambio(this.value)"  onkeyup="findCambio(this.value)"/>
                                                    </div>
                                                    <div class="">
                                                        <label for="" class="col-form-label">Cambio</label><br>
                                                        <h2 class="Cambio" id="vuelto"></h2>
                                                    </div>
                                                </div>
...
function findCambio(val)
{
    console.log('findcambio');
    if($('#cambio').val() >= $('#total_method_0').val())
    {
        $('#cambio').val()
        $('#total_method_0').val();
        var ttt = $('#cambio').val() - $('#total_method_0').val();
        $('#vuelto').html('Q. '+ttt.toFixed(2));
    }
...
$("input[type='radio'][name='ctype_id']").change(function() {
    var val = this.value;
    if (val == "0") {
        $("#insurances").hide(300);
...
function getPrice(product_id, variant_id) {
    ...
    {
       var insurance = $('select[name="insurance_id"]').val();

        console.log(insurance);
    
       $.ajax({
            url: '<?php echo base_url();?>admin/get_product_price/' + product_id + '/' + insurance,
            success: function(response) {
                console.log(response);
                jQuery('#sb_' + variant_id).val(response);
                jQuery('#sb_' + variant_id).attr('readonly', true);

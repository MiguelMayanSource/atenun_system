...
input[type=radio]:checked:after {
	...
	<div class="modal-content animated fadeInDown" style="border-radius:20px;">
	    <?php 
            ...
            if (count($dats) == 0){
            ?>
	    <form id="formNoPat" action="<?php echo base_url();?>admin/patients/create_no_pathological/<?php echo $param2;?>" method="post">
	        <?php }
	         else {
            ?>
	        <form id="formNoPat" action="<?php echo base_url();?>admin/patients/update_no_pathological/<?php echo $param2;?>" method="post">
	            <?php } ?>

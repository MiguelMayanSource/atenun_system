        ...
        <div id="sticky">
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li class="side-li">
                            <a class="side-items " href="<?php echo base_url();?>admin/patient_profile/<?php echo base64_encode($details['patient_id']);?>/">
                                <i class="side-icon picons-thin-icon-thin-0002_write_pencil_new_edit"></i>
                                Editar perfil
                            </a>
                        </li>
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>admin/medical_history/<?php echo base64_encode($details['patient_id']);?>/">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>admin/patients/update" method="POST" enctype="multipart/form-data" id="doc_form">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/patient_history/'.$patient_id?>",
            type: "POST"
        },

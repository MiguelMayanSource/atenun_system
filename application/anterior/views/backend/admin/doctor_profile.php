        ...
        <div id="sticky">
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>admin/doctor_profile/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;    font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> <?php if($owner == 1):?> Editar perfil <?php else:?> Ver
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>admin/doctors/edit/<?php echo $details['admin_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12" >
...
<script>
    ...
    function deactivateDocument(id) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/deactivate_document/"+id,
                    success: function (response) {
                        console.log(response);
                        if (response) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/admins/delete_admin/" + admin_id;
        }
    })
}

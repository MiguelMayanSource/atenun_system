                    ...
                    <div class="table-responsive">
                        ...
                        $n = 1; foreach($appointments->result_array() as $appointment): ?>
                                <tr style="font-family:'Poppins';font-size:14px;">
                                    <td><a href="<?php echo base_url();?>admin/treatment_details/<?php echo base64_encode($appointment['treatment_id']);?>">
                                    ...
                                    <td>
                                        ...
                                        <i onclick="window.open('<?php echo base_url();?>admin/treatment_archive/email/<?php echo $appointment['treatment_id'];?>/<?php echo $patient_id;?>');" class="picons-thin-icon-thin-0315_email_mail_post_send" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Enviar recibo por correo"></i>
                                        <i onclick="window.location.href='<?php echo base_url();?>admin/treatment_archive/pdf/<?php echo $appointment['treatment_id'];?>/<?php echo $patient_id;?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Descargar PDF"></i>
                                        <?php endif;?>
...
function treatment_delete(element_id) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>admin/treatment_archive/delete/' + element_id,

...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12 mb-2">
                            ...
                            <form class="repeater" action="<?php echo base_url();?>admin/journal/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-4">
        ...
        <form method="POST" action="<?php echo base_url();?>admin/printFormType/journal" id="frmJ" target="">

...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <form class="repeater" action="<?php echo base_url();?>admin/general/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-12">
        ...
        <form method="post" action="<?php echo base_url();?>admin/printFormType/general/" id="frmG" target="">
...
<script type="text/javascript">
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/setChecksGeneral/",
            data: {
                vals: vals,
            },
            dataType: "json",

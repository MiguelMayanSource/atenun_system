...
<div class="modal-content animated fadeInDown">
    ...
    <div class="modal-footer" style="text-align:justify;padding:25px;">
        ...
        <br>
        <a class="btn btn-success" href="<?php echo base_url();?>admin/appointment/finish/<?php echo base64_encode($row['appointment_id']);?>"><i class="picons-thin-icon-thin-0133_arrow_right_next"></i> Finalizar cirugía </a>
    </div>
</div>
<?php endforeach;?>
...
function deleteEvent() {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/appointments/delete_calendar/" +
                <?php echo $param2?>;
        }
    })
}

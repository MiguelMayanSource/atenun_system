...
<div id="main-content">
    <div class="card-widget">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link " href="<?php echo base_url();?>admin/question_board/<?php echo $codigo;?>/">Inicio</a>
            </li>
            <li class="nav-item">
        ...
        <div class="content-box">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <form action="<?php echo base_url();?>admin/multiple_choice/create/<?php echo $codigo;?>" method="post">
                            <div class="row">
                                <div class="col-sm-10">

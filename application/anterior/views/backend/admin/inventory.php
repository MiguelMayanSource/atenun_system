        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <a href="<?php echo base_url();?>admin/inventory_products/<?php echo base64_encode($row['inventory_id']);?>"><div class="pt-user-name" >
...
function delete_inventory(inventory_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/inventory/delete_inventory/" + inventory_id;
        }
    })
}
</script>
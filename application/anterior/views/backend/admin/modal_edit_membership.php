...
<?php 
$membership = $this->db->get_where('membership',array('membership_id'=>base64_decode($param2)))->row_array();
?>
<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    <form action="<?php echo base_url();?>admin/memberships/update_membership/<?= $membership['membership_id']; ?>" method="POST" enctype="multipart/form-data">
        <div class="modal-header" style="background-color:#fff;  box-shadow: 0 4px 2px -2px 000;">
            <h4 style="font-size:21px; color:#565b6b; font-family:'Poppins';"><span style="vertical-align:-3px"> <i class="batch-icon-user-2-add"></i> Editar membresia</span></h4>

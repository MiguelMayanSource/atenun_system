        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <form action="<?php echo base_url() . 'staff/samples/create/' . $param2; ?>" method="post" enctype="multipart/form-data" id='formSample'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                                <div class="form-group">
                                    ...
                                    <select name="doctors_id" class='form-control basic' required id='doctor_id' onChange="getNewDr(this.value)">
                                ...
                                <div class="form-group" id="doctor_name" style="display:none">
                                    <label>Nombre del Dr.</label>
                                    <input class='form-control' name="doctor_name"  placeholder='Nombre del Dr.'></input>
                                </div>
                                <div class="form-group">
                                    ...
                                    <table class="table" style="margin: 20px;">
                                        <tbody id="piezas">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="" style="width:230px;">
                                                        <label for="simpleinput">Examen:</label>
                                                        <select  class="form-control basic labs" name="exmans[]" id="examns_0" onchange="getPrice(this.value,0)">
                                                            <option value="">Seleccionar</option>
                                                        </select>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="" style="width:200px;">
                                                        <label>Precio</label>
                                                        <input class='form-control total' type="number"  readonly min='0' onchange="sum_total()" onkeyup="sum_total()" name='price[]' id='ttl-0' readonly="true">
                                                    </div>
                                                </td>
                            ...
                            <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                                <div class="form-group">
                                    ...
                                    <a style='Float:right; display:none' href="<?php echo base_url(); ?>staff/samples_new" class="btn btn-warning sample_new">Nueva orden</a>
...
function getPatients(name) {
    ...
    if (name.length > 0) {
        $.ajax({
            url: "<?php echo base_url() . 'staff/getPatients/'; ?>",
            type: "POST",
            data: {
                name: name,
            },
...
function getDiagnostico(doctor_id) {
    ...
    $.ajax({
        url: "<?php echo base_url() . 'staff/getDiagnostico'; ?>",
        type: "POST",
        dataType: "json",
        data: {
            doctor_id: doctor_id,
...
function getPrice(element, price_id) {
    ...
    $.ajax({
        url: "<?php echo base_url() . 'staff/getPrice/'; ?>",
        type: "POST",
        data: {
...
function addPieza() {
    ...
    $.ajax({
        url: "<?php echo base_url() . 'staff/getPieza2'; ?>",
        type: "POST",
        data: {
...
function print(code) {
    ...
    $.ajax({
        url: "<?php echo base_url() . 'staff/samples/get/'; ?>",
        type: 'post',
        data: {
            code: code
        },
...
function laboratoriesExamns(value, no) {
    ...
    $.ajax({
        url: '<?php echo base_url() ?>staff/getExamns',
        type: 'POST',
        data: {
            laboratories: value,
        },

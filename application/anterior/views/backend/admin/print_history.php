    ...
    <div class=" wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card-widget">
                        ...
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>admin/excel/<?php echo base64_encode($ID);?>">EXCEL</a>
                        <span class="app-divider2"></span>
                        <div class="row">
                            <div class="col-sm-12">
        ...
        $(document).ready(function() {
            var dataTable = $('#user_data').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "<?php echo base_url() . 'admin/getTable/history/'; ?>",
                    type: "POST"
                },

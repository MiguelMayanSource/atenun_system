            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>admin/staff_permissions/<?php echo base64_encode($staff_id);?>/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0015_fountain_pen"></i> Permisos <span class="side-active"></span></a>
                        </li>
                    </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php $this->db->where('role_id', $details['role_id']);
                                $roles = $this->db->get('role')->result_array();
                                foreach($roles as $rl):
                                    $perm = unserialize($rl['permissions']);?>
                            <form action="<?php echo base_url().'admin/permissions/apply/'.base64_encode($details['role_id']);?>" method="POST" enctype="multipart/form-data">

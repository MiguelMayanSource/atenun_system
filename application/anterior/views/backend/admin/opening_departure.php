            ...
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3" style="float: right;">
                                <div class="btn-group focus-btn-group">
                                    <a class="btn btn-info" href="<?php echo base_url();?>admin/opening/">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>admin/opening_departure/create/" method="POST" enctype="multipart/form-data" id="frmR">
                                <div class="row">
...
<script type="text/javascript">
    ...
    function verifyPeriod() {
        ...
        if ($.isNumeric(period) && period.length == 4) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/verifyPeriodOpen/",
                data: {
                    period: period,
                },
                dataType: "json",
    ...
    function chargeDeparture() {
        ...
        if ($.isNumeric(period) && period.length == 4) {
            if (!ldD) {
                $.ajax({
                    method: "POST",
                    url: "<?php echo base_url();?>admin/chargeOpenDeparture/",
                    data: {
                        year: period,
                    },
                    beforeSend: function () {
    ...
    function verifyForm() {
        ...
        if (valForm && chD) $("#frmR").attr("action", "<?php echo base_url();?>admin/opening_departure/create/");

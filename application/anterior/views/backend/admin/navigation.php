<aside class="side-nav side-nav-small scroll" id="nav" style="overflow-y: auto !important;">
    ...
    <ul class="side-nav-wrapper">
        ...
        <li class="movil_brand">
            <a style="text-align:center;" href="<?php echo base_url();?>admin/panel/">
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Chat">
            <a href="<?php echo base_url();?>admin/chat/" <?php if ($page_name == 'chat' || $page_name == 'messages'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Usuarios">
            <a href="<?php echo base_url();?>admin/admins/" <?php if ($page_name == 'admins' || $page_name == 'new_admin' || $page_name == 'new_doctor' ||$page_name == 'doctors' || $page_name == 'staff' || $page_name == 'receptionist' || $page_name == 'providers' || $page_name == 'staff_profile' || $page_name == 'admin_profile'  || $page_name == 'doctor_profile'|| $page_name == 'permission_details'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Citas">
            <a href="<?php echo base_url();?>admin/appointments/" <?php if($page_name == 'calendar' ||$page_name == 'appointment_details' || $page_name == 'appointments' || $page_name == 'pending_payment' || $page_name == 'soon' || $page_name == 'rescheduled' || $page_name == 'cancelled' || $page_name == 'archived'):?> class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Hospitalizacion">
            <a href="<?php echo base_url();?>admin/stabilitation/" <?php if ($page_name == 'stabilitation' || $page_name == 'stabilitation_details'):?> class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Inventario">
            <a href="<?php echo base_url();?>admin/inventory/" <?php if ($page_name == 'inventory' || $page_name == 'categories' || $page_name == 'subcategories' || $page_name == 'equipment' || $page_name == 'supplies' || $page_name == 'history' || $page_name == 'inventory_products') :?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="planes">
            <a href="<?php echo base_url();?>admin/plans/" <?php if ($page_name == 'Puntos y Memebresias' ) :?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Ventas">
            <a href="<?php echo base_url();?>admin/sales_management/" <?php if ($page_name == 'sales_management' || $page_name == 'sales_insurance' || $page_name == 'new_sale' || $page_name == 'sales' || $page_name == 'sale_details'):?>class="currentPage" <?php endif;?>>
        ...
        <?php endif;?>
        <?php  if ($check['view_financial'] == 1):?>
        <!-- <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Finanzas">
            <a href="<?php echo base_url();?>admin/financial/" <?php if ($page_name == 'financial'):?>class="currentPage" <?php endif;?>>
        ...
        <?php endif; if ($check['view_banks'] == 1):?>
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Bancos">
            <a href="<?php echo base_url();?>admin/bank_accounts/" <?php if ($page_name == 'bank_accounts' || $page_name == 'bank_checks' || $page_name == 'bank_transfers' || $page_name == 'account_types' || $page_name == 'currencies' || $page_name == 'banks'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Laboratorios">
            <a href="<?php echo base_url();?>admin/samples/" <?php if ($page_name == 'samples'|| $page_name == 'samples_new'  || $page_name == 'laboratory' || $page_name == 'laboratory'  ):?>class="currentPage" <?php endif;?>>
                <i class="iconBox picons-thin-icon-thin-0816_microscope_laboratory"></i>
                <span class="sideBox-item-name">Laboratorios</span>
            </a>
        </li>
        <?php endif; ?>   
         <?php if ($check['view_rayx'] == 1):?>
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Rayos X">
            <a href="<?php echo base_url();?>admin/rayx/" <?php if ($page_name == 'rayx'|| $page_name == 'new_rayx'  ):?>class="currentPage" <?php endif;?>>
                ...
                <span class="sideBox-item-name">Rayos X</span>
            </a>
        </li>
         <?php endif; ?>   
          <?php if ($check['view_ultras'] == 1):?>
          <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Ultrasonidos">
            <a href="<?php echo base_url();?>admin/ultras/" <?php if ($page_name == 'ultras'|| $page_name == 'new_ultra'  ):?>class="currentPage" <?php endif;?>>
                ...
                <span class="sideBox-item-name">Ultrasonidos</span>
            </a>
        </li>
         <?php endif; ?>   
        <?php        if ($check['view_marketing'] == 1):?>
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Marketing">
                <a href="<?php echo base_url();?>admin/whatsapp/" <?php if ($page_name == 'whatsapp' ):?>class="currentPage" <?php endif;?>>
            ...
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Nueva cita">
                <a style="font-size:15px; padding-left: 20px; text-align:center;" href="<?php echo base_url();?>admin/quote/">
            ...
            <?php endif; ?>
          <?php if ($check['view_laboratories'] == 1):?>
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Nueva laboratorio">
                <a style="font-size:15px; padding-left: 20px; text-align:center;" href="<?php echo base_url();?>admin/samples_new_rec/">
                    <div class="third-floated-btn new_app">
                        <i class="iconBox picons-thin-icon-thin-0816_microscope_laboratory" style="color:#fff"></i>
                    </div>
                </a>
            </li>
            <?php endif;?>

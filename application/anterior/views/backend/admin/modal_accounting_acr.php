        ...
        <div class="modal-body">
            <div class="form-group">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="profile-tile profile-tile-inlined modal-accounting" onclick="window.location.href='<?php echo base_url();?>admin/adjust/';">
                        ...
                        <div class="col-sm-4">
                            <div class="profile-tile profile-tile-inlined modal-accounting" onclick="window.location.href='<?php echo base_url();?>admin/closing/';">
                                <div class="profile-tile-box">
                                    <div class="tile-controls"></div>
                        ...
                        <div class="col-sm-4">
                            <div class="profile-tile profile-tile-inlined modal-accounting" onclick="window.location.href='<?php echo base_url();?>admin/opening/';">
                                <div class="profile-tile-box">
                                    <div class="tile-controls"></div>

...
<div id="main-content">
    <div class="card-widget">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>admin/question_board/<?php echo $codigo;?>/">Detalles</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url();?>admin/questions/<?php echo $codigo;?>">Preguntas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>admin/survey_results/<?php echo $codigo;?>">Resultados</a>
            </li>
        </ul>
        <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="font-family:'Poppins';font-size:14px;font-weight:bold;color:#4b4a55" class="">
                                            ...
                                            <td>
                                                ...
                                                <?php elseif($pregunta['type'] == 'multiple_choice'):?>
                                                <a href="<?php echo base_url();?>admin/update_multiple/<?php echo $pregunta['question_id'];?>"><i style="vertical-align:-3px;color:#a7aabb;font-size:18px;font-weight:bold;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i></a>
                                                <?php endif;?>
    ...
    <div class="fcp-content">
        ...
        <div class="fcp-group">
            ...
            <div class="fcp-group-contents">
                ...
                <div class="fcp-field">
                    <a href="<?php echo base_url();?>admin/multiple_choice/<?php echo $codigo;?>/"><label for="">Opción múltiple</label></a>
                </div>
                <div class="fcp-field">
...
<div class="modal" id="888Modal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown" style="border-radius:20px;">
            <form action="<?php echo base_url();?>admin/questions/satisfaction/<?php echo $codigo;?>" method="post">
...
<div class="modal" id="124Modal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown" style="border-radius:20px;">
            <form action="<?php echo base_url();?>admin/questions/text/<?php echo $codigo;?>" method="post">
                <div class="modal-header" style="background-color:#fff;border-radius:20px;  box-shadow: 0 4px 2px -2px 000;">
...
<script src="https://app.miaula.com.gt/assets/theme/js/demo_customizer.js?version=4.4.0"></script>
<script>
...
function delete_question(question_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/questions/delete/" + question_id;
        }
    })
}
</script>
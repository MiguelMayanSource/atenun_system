            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>admin/departure/create/" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <tr class="" id="rowField_1">
                                                        <td id="selectNomen_1">
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-addon input-group-append" id="divSwitch_1" style="display: none;">
                                                                    <div class="input-group-text">
                                                                        <div class="custom-control custom-switch" data-toggle="tooltip" data-placement="right" title="Ver facturas">
                                                                            <input type="checkbox" class="check-purchase custom-control-input" id="switch_1" switch="info" onchange="checkPurchase(this, 1)" />
                                                                            <label for="switch_1" class="custom-control-label"></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script type="text/javascript">
    ...
    function searchNumDoc(i) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/countExistPurchase/",
            data: {
                number: number
            },
            dataType: "json",

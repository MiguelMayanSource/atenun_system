                        ...
                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                            <div class="form-group">
                                ...
                                <select name="doctors_id" class='form-control basic' required id='doctor_id'>
                                    ...
                                    <option value="<?php echo $doc['admin_id'];?>" <?php echo ($data_edit->doctors_id == $doc['admin_id'] ) ? 'selected':''; ?>><?php echo $doc['first_name'].' '.$doc['last_name'];?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <div class="form-group">
                                                    ...
                                                    <select onchange="laboratoriesExamns(this.value,<?php echo $id; ?>)" class="form-control basic labs" name="laboratories[]" id="laboratories_<?php echo $id; ?>">
                                                        ...
                                                        <?php 
                                                           ...
                                                           $this->db->where('type',3);
                                                            ...
                                                            foreach($db as $info):
                                                        ?>
                                                        <option value="<?php echo $info['product_id'];?>" <?php echo $piesa['laboratory_id']==$info['product_id']?'selected':'';?>><?php echo $info['name']?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
                                            </td>

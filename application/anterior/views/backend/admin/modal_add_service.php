<div class="modal-content animated fadeInDown">
    ...
    <form action="<?php echo base_url();?>admin/inventory_products/create_service" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 row" id="is_exist">
                            <div class="col-sm-12 col-md-8 mb-3">
                                <label class="form-label" for="exampleFormControlSelect9"><b>Servicio:</b></label><span style="color:red">*</span>
                                <select class="form-control mb3 select2" required name="product_id">
                                    <option value="">Seleccionar</option>
                                    <?php  $products = $this->db->get_where('product', array('type'=>2,'status'=>1))->result_array();
                        ...
                        <div class="col-md-12 row" id="is_new" style="display:none">
                            <div class="col-sm-12 col-md-4 mb-3">
                                ...
                                <select class=" mb3 select2"  name="category_id" required  onchange="getSubcategories(this.value);">
                                    <option value="">Seleccionar</option>

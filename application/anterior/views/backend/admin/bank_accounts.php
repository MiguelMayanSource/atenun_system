                ...
                <div class="card-b">
                    ...
                    <ul class="nav nav-pills nav-justified mb-3" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link <?php if($property == 1) echo "active";?>" href="<?php echo base_url().'admin/bank_accounts/1';?>">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                <span class="d-none d-sm-block">Propias</span> 
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link <?php if($property == 2) echo "active";?>" href="<?php echo base_url().'admin/bank_accounts/2';?>">
                        ...
                        <div class="col-lg-12">
                            <div class="btn-toolbar mb-3">
                                <div class="">
                                    ...
                                    &nbsp;
                                    &nbsp;
                                    <a href="<?php echo base_url();?>admin/account_types/" class="btn btn-primary">
    ...
    function desactivarCuenta(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/bank_accounts/deactivate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function activarCuenta(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/bank_accounts/activate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function eliminarCuenta(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/bank_accounts/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/whatsapp_notifications/">
    ...
    <div class="row">
        ...
        <div class="col-md-4 m-b-30">
            <div class="card-box">
                ...
                <div class="card-b">
                    <form action="<?php echo base_url();?>admin/whatsapp_notifications/update/<?php echo $noti['type'];?>" method="POST" enctype="multipart/form-data" id="formWhatsapp">

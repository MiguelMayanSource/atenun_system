...
<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    <?php 
            ...
            if (count($dats) == 0){
            ?>
    <form id="formPeri" action="<?php echo base_url();?>admin/patients/create_perinatal/<?php echo $param2;?>" method="post">
        <?php }
	         else {
            ?>
        <form id="formPeri" action="<?php echo base_url();?>admin/patients/update_perinatal/<?php echo $param2;?>" method="post">
            <?php } ?>

...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form class="repeater" action="<?php echo base_url();?>admin/ledger/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-4">
                            ...
                            <table class="table mb-0" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url().'admin/departure_edit/'.base64_encode($dt['departure_id']);?>"><?php echo $dt['details'];?></a></td>
                                        <td>
        ...
        <form method="POST" action="<?php echo base_url();?>admin/printFormType/ledger/" id="frmL" target="">

...
<div id="main-content">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card-b">
                <form class="mb-15" id="search-form" action="<?php echo base_url();?>admin/sales_insurance/Mw==" method='POST'>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group  m-b-15">
                               ...
                               <select name="insurance_id" class="itemName form-control select2" id="insurance_id">
                                <?php $insurance = $this->db->get('insurance')->result();?>
                                <?php foreach($insurance as $ins):?>
                                    <option value="<?php echo $ins->insurance_id;?>" <?php echo $insurance_id == $ins->insurance_id ? 'selected' : '';?>><?php echo $ins->name;?></option>
                                <?php endforeach;?>
                               </select>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/sales_insurance/'.$insurance_id; ?>",
            type: "POST",
            data: function (d) {

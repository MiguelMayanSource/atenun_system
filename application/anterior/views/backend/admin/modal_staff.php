...
<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    ...
    <form action="<?php echo base_url();?>admin/staff/update/<?php echo $row['staff_id'];?>" method="POST" enctype="multipart/form-data" id="staffUpdate">
...
function validateEmail() {
    ...
    if (!validacion_email.test(email)) {
        ...
        $.ajax({
            type: "POST",
            url: "https://medicaby.com/admin/check_m",
            data: {
                'mail': email
            },

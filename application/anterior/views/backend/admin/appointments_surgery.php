        ...
        <div id="sticky_left">
            <div class="todo-sidebar-section">
                <h5 class="todo-sidebar-section-header">
                    <span>Cirugías hoy</span><a class="todo-sidebar-section-toggle" href="<?php echo base_url();?>/admin/appointments"><i class="batch-icon-revert"></i></a>
                </h5>
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters" method="POST" action="<?php echo base_url();?>admin/appointments">
            ...
            <div class="col-sm-12">
                <div class="alert alert-info">
                    ...
                    <span class="alert-content">En esta sección podrás visualizar todas las cirugías que han sido
                        programadas por tu equipo de trabajo, recuerda que puedes agendar una nueva haciendo click <span class="alert-lined"><a href="<?php echo base_url();?>admin/appointment/" style="color:#0044e9">aquí</a>.</span></span>
                </div>
            </div>
            <div class="col-sm-7">

<?php $grupos = $this->crud_model->getGroupsAccount(); $debit = 0; $credit = 0; $total = 0; $cont = 0;?>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="">
            <table class="table table-bordered mb-0">
                ...
                <tbody id="rowInputs">
                    <?php $nom = $this->crud_model->getNomenByCode("6.01.01.001");
                        $nom_id = $nom['nomenclature_id'];
                        $total = $this->crud_model->getTotalYearClosePL($initial, $final);
                        $debit += $total; $cont++;?>
                    ...
                    <?php for ($i=2; $i <= 21; $i++):
                        $idx = $this->crud_model->correlativeCode($i, null, 2);
                        $nom = $this->crud_model->getNomenByCode("5.02.01.0$idx");
                        $nom_id = $nom['nomenclature_id'];
                    ...
                    <tr class="" id="rowField_<?php echo $cont;?>">
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control debe" id="debe_<?php echo $cont;?>" name="debe[]" value="" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control haber" id="haber_<?php echo $cont;?>" name="haber[]" value="<?php echo $total;?>" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <input type="hidden" name="position[]" id="position_<?php echo $cont;?>" value="" />
                    ...
                    <?php for ($i=11; $i <= 15; $i++):
                        $idx = $this->crud_model->correlativeCode($i, null, 2);
                        $nom = $this->crud_model->getNomenByCode("5.03.01.0$idx");
                        $nom_id = $nom['nomenclature_id'];
                        $total = $this->crud_model->getTotalYearNom($nom_id, $initial, $final, 5);?>
                    <?php if($total != 0):
                        $credit += $total; $cont++;?>
                    ...
                    <?php for ($i=22; $i <= 23; $i++):
                        $idx = $this->crud_model->correlativeCode($i, null, 2);
                        $nom = $this->crud_model->getNomenByCode("5.02.01.0$idx");
                        $nom_id = $nom['nomenclature_id']; $cont++;?>
                    <tr class="table-light" id="rowField_<?php echo $cont;?>">
                        <td id="selectNomen_<?php echo $cont;?>">
                            <input type="hidden" name="nomen_id[]" id="nomen_id_<?php echo $cont;?>" value="<?php echo $nom_id?>" />
                            <input type="hidden" name="type_nom[]" id="type_nom_<?php echo $cont;?>" value="nomenclature" />
                            <?php echo $nom['code'].' '.$nom['name'];?>
                        </td>
                        <td><input type="hidden" name="debe[]" id="debe_<?php echo $cont;?>" value="" /></td>
                        <td><input type="hidden" name="haber[]" id="haber_<?php echo $cont;?>" value="" /></td>
                        <td><input type="hidden" name="position[]" id="position_<?php echo $cont;?>" value="C" /></td>
                    </tr>
                    <?php endfor;?>
                    <?php for ($i=24; $i <= 28; $i++):
                        $idx = $this->crud_model->correlativeCode($i, null, 2);
                    ...
                    <?php endfor;
                        $nom = $this->crud_model->getNomenByCode("5.02.01.029");
                        $nom_id = $nom['nomenclature_id']; $cont++;?>
                    <tr class="table-light" id="rowField_<?php echo $cont;?>">
                        <td id="selectNomen_<?php echo $cont;?>">
                            <input type="hidden" name="nomen_id[]" id="nomen_id_<?php echo $cont;?>" value="<?php echo $nom_id?>" />
                    ...
                    <?php for ($i=1; $i <= 2; $i++):
                        $idx = $this->crud_model->correlativeCode($i, null, 2);
                        $nom = $this->crud_model->getNomenByCode("5.04.01.0$idx");
                        $nom_id = $nom['nomenclature_id'];
                        $total = $this->crud_model->getTotalYearNom($nom_id, $initial, $final, 5);
                        $credit += $total; $cont++;?>
                    <tr class="" id="rowField_<?php echo $cont;?>">
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Liquidación de las cuentas de resultados de saldo deudor</textarea>
    </div>

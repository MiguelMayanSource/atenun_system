...
<div class="row">
            ...
            <table class="table table-bordered mb-0">
                ...
                <tbody id="rowInputs">
                    <tr class="" id="rowField_1">
                        <?php $nom = $this->crud_model->getNomenByCode("2.02.01.004");
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Razón por contabilizar el prestamo bancario cancelado en el 2022</textarea>
    </div>

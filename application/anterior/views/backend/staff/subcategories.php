    ...
    <div class="row">
        <div class="col-sm-12"><br>
            <div class="title-header">
                <h3 class="module-title"> <a href="javascript:void(0);" onclick="history.back()"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i></a> Sub Categorías de inventario</h3>
                <a class="add-buton pull-right" href="javascript:void(0);" data-toggle="modal" data-target="#2new_category">+ Nueva Sub Categoría</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card-b">
...
<div class="modal" id="2new_category">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>staff/subcategories/create" method="POST">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/subcategories'; ?>",
            type: "POST"
        },
...
function delete_subcategory(category_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/subcategories/delete/" + category_id;
        }
    })
}
</script>
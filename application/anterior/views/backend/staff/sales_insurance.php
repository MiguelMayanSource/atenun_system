...
<div id="main-content">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card-b">
                <form class="mb-15" id="search-form" action="<?php echo base_url();?>staff/sales_insurance/Mw==" method='POST'>
                    <div class="row mb-6">
...
function delete_sale(sale_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/sales/anulation/" + sale_id;
        }
    })
}
</script>

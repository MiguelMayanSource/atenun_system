    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/inventory_reports/">
                    ...
                    <div class="card-widget">
                        ...
                        <ul class="services_more">
                            <?php $prod = $this->db->limit(8)->order_by('product_id','DESC')->get('product')->result_array();
                                    foreach($prod as $res):?>
                            <a href="<?php echo base_url(); ?>staff/history/<?php  echo $res['product_id'];?>">
...
function total_table(card) {
    $.ajax({
        url: '<?php echo base_url();?>staff/total_inventario/',
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Todos los productos</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_inventory_report/all">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_inventory_report/all">EXCEL</a>
                        `);
        }
    });
}
...
function alert_table(card) {
    ...
    $.ajax({
        url: '<?php echo base_url();?>staff/alert_table/',
        success: function(response) {
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos en alerta</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_inventory_report/alert">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_inventory_report/alert">EXCEL</a>
                        `);
        }
    });
}
...
function vencido_table(card) {
    ...
    $.ajax({
        url: '<?php echo base_url();?>staff/vencido_inventario/',
        success: function(response) {
            console.log(response);
            jQuery('#table_ajax').html(response);
            $('#mainTable').DataTable();
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos vencidos</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_inventory_report/expirate">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_inventory_report/expirate">EXCEL</a>
                        `);
        }
    });
}
...
function vencer_table(card) {
    $.ajax({
        url: '<?php echo base_url();?>staff/vencer_inventario/',
        success: function(response) {
            jQuery('#table_ajax').html(response);
            $('#mainTable').DataTable();
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos por vencer</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_inventory_report/per_expirate">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_inventory_report/per_expirate">EXCEL</a>
                        `);
        }
    });
}
...
function agotado_table(card) {
    $.ajax({
        url: '<?php echo base_url();?>staff/agotado_inventario/',
        success: function(response) {
            jQuery('#table_ajax').html(response);
            $('#mainTable').DataTable();
            previus.classList.remove("selected_property");
            ...
            $('#title').html(`<h4 class="panel-content-title" >Productos agotados</h4>
                        <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_inventory_report/out">IMPRIMIR</a>
                        <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_inventory_report/out">EXCEL</a>
                        `);
        }
    });
}

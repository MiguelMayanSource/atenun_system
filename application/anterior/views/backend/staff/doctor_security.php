    ...
    <div class="todo-sidebar">
        <div class="todo-sidebar-section" style="border-bottom:0px">
            ...
            <div class="todo-sidebar-section-contents">
                <ul class="tasks-list">
                    <li class="side-li">
                        <a class="side-items" href="<?php echo base_url();?>staff/doctor_profile/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;    font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> Editar perfil </a>
                    </li>
                    <li class="side-li">
                    ...
                    <li class="side-li">
                        <a class="side-items active" href="<?php echo base_url();?>staff/doctor_security/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0705_user_profile_security_password_permissions"></i> Contraseña y seguridad <span class="side-active"></span></a>
                    </li>
                    <li class="side-li">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>staff/doctors/update_password_profile/<?php echo $doctor_id;?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
...
function remove_auth() {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/doctors/remove_auth_staff/<?php echo $doctor_id;?>";
        }
    })
}
...
function remove_session($doct_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/doctors/remove_sessions_doc/" + $doct_id;
        }
    })
}
</script>

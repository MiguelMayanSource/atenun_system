    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card-widget">
                ...
                <form action="<?php echo base_url(); ?>staff/points" method="POST">
                    <div class="row">
                        <div class="col-sm-6">
        ...
        <div class="col-3 col-sm-12 col-lg-3 col-xl-3 ">
            <form class=" element-box el-tablo centered trend-in-corner smaller" action="<?php echo base_url(); ?>staff/points/set" method="POST">

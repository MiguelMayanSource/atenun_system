            ...
            <div class="card-widget">
                <div class="table-responsive">
                    <table class="table table-padded" id="user_data">
                        ...
                        <tbody>
                            <?php $memebership = $this->db->get_where('memebership',array(''))->result_array(); 
                            foreach ($memebership as $row):
                            ?>
                            <tr>
                                <td><?php echo $row['name'];?></td>
                                <td><?php echo $row['description'];?></td>
                                <td><?php echo $this->crud_model->count_patient_membership($row['memebership_id']);?></td>
                                <td>
                                    <a class="" href="javascript:void(0)" onclick="showAjaxModal('<?php echo base_url().'modal/popup/modal_edit_membership/'.base64_encode($cat['laboratory_id']);?>')">
                                        <i class="iconBox picons-thin-icon-thin-0001_compose_write_pencil_new"></i>
                                    </a>
                                    <a class="" href="<?php echo base_url();?>staff/membership_details/<?php echo $row['memebership_id']; ?>">
                                        <i class="iconBox picons-thin-icon-thin-0064_bullet_list_view"></i>
                                    </a>
                                    <a class="" href="javascript:void(0)" onclick="desactivarPartida('')">
...
<div class="modal" id="1specialtiesModal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>staff/insurance/create" method="POST">

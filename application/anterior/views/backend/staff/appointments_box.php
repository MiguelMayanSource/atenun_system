        ...
        <div id="sticky_left">
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form method="POST" action="<?php echo base_url();?>staff/appointments_box">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form method="POST" action="<?php echo base_url();?>staff/appointments">
            ...
            <div class="col-sm-12">
                <div class="alert alert-info">
                    ...
                    <span class="alert-content">En esta sección podrás visualizar todas las citas que han sido
                        programadas por tu equipo de trabajo, recuerda que puedes agendar una nueva haciendo clic <span class="alert-lined"><a href="<?php echo base_url();?>staff/appointment/" style="color:#0044e9">aquí</a>.</span></span>
                </div>
            </div>
            <div class="col-sm-7">
                                        ...
                                        <div class="pi-foot">
                                            <div class="tags">
                                                <?php if($appointment['status'] == 6): ?>
                                                    <a class="tag" data-toggle="tooltip" data-placement="right" title="" data-original-title="Cobrar" href="<?php echo base_url();?>staff/pay_appointment/<?php echo base64_encode($appointment['appointment_id']);?>"><i class="picons-thin-icon-thin-0421_money_credit_card_coins_payment alert-<?php echo $className;?>-text"></i></a>
                                                <?php endif;?>
                                                <?php if($appointment['status'] == 1): ?>
                                                    <a class="tag" data-toggle="tooltip" data-placement="right" title="" data-original-title="Detalles de cobro" href="<?php echo base_url();?>staff/pay_appointment/<?php echo base64_encode($appointment['appointment_id']);?>"><i class="picons-thin-icon-thin-0421_money_credit_card_coins_payment alert-<?php echo $className;?>-text"></i></a>
                                                <?php endif;?>
                                            </div>
                                        </div>
                                    </div>
...
function cancel_appointment(appointment_id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: "<?php echo base_url();?>staff/appointments/cancel/" + appointment_id,
...
function delete_appointment(appointment_id) {
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: "<?php echo base_url();?>staff/appointments/delete/" + appointment_id,
                error: function(xhr, ajaxOptions, thrownError) {
                    alert("Ups! Algo salio mal.");
                },
                success: function(data) {
...
function appointment_details(appointment_id) {
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>staff/vital_signs_card/' + appointment_id,
        dataType: "html",
        error: function(xhr, ajaxOptions, thrownError) {
            alert("Ups! Algo salio mal.");
        },
...
function appointment_new_vital_sign(appointment_id) {
    $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>staff/new_vital_signs_card/' + appointment_id,
        dataType: "html",
        error: function(xhr, ajaxOptions, thrownError) {
            alert("Ups! Algo salio mal.");
        },
...
function updateConsulta(cl, _id, text) {
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>staff/patient_app",
        type: "post",
        data: {
            'cl': cl,
            'id': _id,

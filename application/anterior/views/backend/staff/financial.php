        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/financial/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0425_money_payment_dollar_cash"></i>
                        </div> <span>Finanzas</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>staff/financial_stabilitation/">
...
<div id="main-content">
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <form action="<?php echo base_url();?>staff/financial/create" method="POST" enctype="multipart/form-data">
                <div class="card-widget">
...
$(document).ready(function() {
    ...
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/financial'; ?>",
            type: "POST"
        },
...
function delete_income(income_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/financial/delete/" + income_id;
        }
    })
}
</script>
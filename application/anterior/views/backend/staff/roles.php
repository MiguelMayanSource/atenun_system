        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                 ...
                 <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/roles/">
                ...
                <table class="table table-padded" id="user_data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url().'staff/permissions/'.base64_encode($rl['role_id']);?>">Ver</a></td>
                            <td>
    ...
    function deactivateRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/roles/deactivate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function activateRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/roles/activate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function deleteRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/roles/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

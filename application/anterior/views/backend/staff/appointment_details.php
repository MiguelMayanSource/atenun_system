                            ...
                            <div class="patient-info">
                                <div class="profile-tile-box">
                                    ...
                                    <div class="pt-user-last">
                                        <a href="<?php echo base_url(); ?>staff/patient_profile/<?php echo base64_encode($det['patient_id']); ?>" style="color:black;text-decoration:none;"><?php echo $this->accounts_model->get_name('patient',$det['patient_id']);?></a>.
                                    </div>
                                    <br>
        ...
        <div class="col-sm-8">
            ...
            <div style="width:auto">
                <ul class="nav nav-tabs">
                    ...
                    <!--
                    <li class="nav-item">
                        <a class="nav-link " data-toggle="tab" href="#c-rays" id="d-rays">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24">
...
function putVitalSings() {
    ...
    $page.append(`<span style="margin-bottom:10px; display:block;font-weight:bold;font-size:16px;font-family:'Poppins', sans-serif">Últimos signos vitales registrados</span>
                <div >
                    <b>Peso:</b> <?php echo  $vs['w'] ?> (lbs)
                </div>
                <div >

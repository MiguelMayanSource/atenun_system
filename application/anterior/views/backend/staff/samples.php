    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                ...
                <a class="add-buton pull-right" href="<?php echo base_url().'staff/inventory_products/MTA='?>">Laboratorios</a>
                <a class="add-buton pull-right" href="<?php echo base_url().'staff/samples_new/0'?>">+ Nueva orden</a>
            </div>
        </div>
        <div class="col-sm-12">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/samples/'; ?>",
            type: "POST"
        },

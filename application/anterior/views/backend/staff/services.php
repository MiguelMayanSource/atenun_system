...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/services'; ?>",
            type: "POST"
        },
...
<div class="modal" id="1new_product">
    <div class="modal-dialog modal-dialog-centered modal-big">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>staff/services/create" method="POST" enctype="multipart/form-data">
...
function delete_inventory(product_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/services/delete/" + product_id;
        }
    })
}
</script>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    ...
                    <form action="<?php echo base_url();?>staff/providers/edit_single/<?php echo $details['staff_id'];?>" method="POST" enctype="multipart/form-data" id="form">
                        <div class="row">
                    ...
                    <form action="<?php echo base_url();?>staff/providers/edit_legal/<?php echo $details['staff_id'];?>" method="POST" enctype="multipart/form-data" id="form">
                        <div class="row">
                            <div class="col-sm-12 mb-2">
                                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                                    <div class="row">

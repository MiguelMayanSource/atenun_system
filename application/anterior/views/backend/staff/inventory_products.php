    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>staff/purchases/">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header"><br>
                ...
                <?php if ($check['masive_delete_inventory'] == 1):?>
                <div>
                ...
                <div>
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url();?>staff/categories">+ Categorías</a>
                        <a class="dropdown-item" href="<?php echo base_url();?>staff/subcategories">+ Subcategorías</a>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/inventory/'.$inventory_id; ?>",
            type: "POST"
        },
...
function delete_inventory(product_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/inventory_products/delete/" + product_id;
        }
    })
}
</script>
...
<div class="modal-content animated fadeInDown">
    ...
    <form action="<?php echo base_url();?>staff/box/new_box/" method="POST" enctype="multipart/form-data">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" disabled value="<?php echo $this->accounts_model->get_name('staff',$this->session->userdata('login_user_id'));?>">
                        </div>

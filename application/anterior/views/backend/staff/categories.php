    ...
    <div class="modal" id="2new_category">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content animated fadeInDown">
                <form action="<?php echo base_url();?>staff/categories/create" method="POST">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/categories'; ?>",
            type: "POST"
        },
...
function delete_category(category_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/categories/delete/" + category_id;
        }
    })
}
    </script>
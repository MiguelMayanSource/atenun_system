...
function addField() {
    ...
    if (laboratory_fields_id != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>staff/laboratory_fields/add",
            type: 'post',
            data: {
...
function addNewField() {
    ...
    if (name != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>staff/laboratory_fields/new_field",
            type: 'post',
            data: {
                laboratory_id: laboratory_id,
                name: name,
...
function saveField(field_id) {
    ...
    if (name != "") {
        ...
        $.ajax({
            url: "<?php echo base_url();?>staff/laboratory_fields/edit",
            type: 'post',
            data: {
                field_id: field_id,
                name: name,
...
function deleteField(field_id) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>staff/laboratory_fields/delete/" + field_id,
        type: 'post',
        data: {
            field_id: field_id,
        },
...
function deleteFieldTemplate(laboratory_template_id) {
    console.log('eliminado');
    $.ajax({
        url: "<?php echo base_url();?>staff/laboratory_fields/delete_field/" + laboratory_template_id,
        type: 'post',
        data: {

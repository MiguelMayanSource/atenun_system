...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            ...
                            <form class="repeater" action="<?php echo base_url();?>staff/statement/" method="POST" enctype="multipart/form-data">
                                <div class="row">
        ...
        <form method="post" action="<?php echo base_url();?>staff/printFormType/statement/" id="frmS" target="">
...
<script type="text/javascript">
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>staff/setChecksStatement/",
            data: {
                vals: vals,
            },
            dataType: "json",

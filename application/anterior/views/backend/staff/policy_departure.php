        ...
        <div class="col-12">
            <div class="card-box">
                <div class="card-b">
                    ...
                    <div class="mb-2">
                        <form action="<?php echo base_url();?>staff/printPDF/policy/" method="POST" id="frmP" enctype="multipart/form-data" target="_blank">
                            <div class="row">
...
<script type="text/javascript">
    ...
    function searchNoCheckEdit(i) {
        ...
        if (reference != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>staff/searchNoCheckAccountEdit/",
                data: {
                    id: id,
                    reference: reference,
                    type: type,

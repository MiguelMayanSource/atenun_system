            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/patient_financial/<?php echo base64_encode($details['patient_id']);?>/"><i class="side-icon picons-thin-icon-thin-0425_money_payment_dollar_cash"></i> Financiero <span class="side-active"></span> </a>
                        </li>
						...
						?>
                                <tr style="font-family:'Poppins';font-size:14px;">
                                    ...
                                    <td>
                                        ...
                                        <i onclick="window.open('<?php echo base_url();?>staff/treatment_archive/email/<?php echo $income['treatment_id'];?>/<?php echo $patient_id;?>');" class="picons-thin-icon-thin-0315_email_mail_post_send" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Enviar recibo por correo"></i>
                                        <i onclick="window.location.href='<?php echo base_url();?>staff/treatment_archive/pdf/<?php echo $income['treatment_id'];?>/<?php echo $patient_id;?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Descargar PDF"></i>

                                        <?php else:?>
                                        <?php if($income['appointment_id'] != ""):?>
                                        <i onclick="window.open('<?php echo base_url();?>staff/sale_details_financial/email/<?php echo $income['appointment_id'];?>/<?php echo $patient_id;?>');" class="picons-thin-icon-thin-0315_email_mail_post_send" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Enviar recibo por correo"></i>
                                        <i onclick="window.open('<?php echo base_url();?>staff/print_receipt/<?php echo $income['appointment_id'];?>', '_blank');" class="picons-thin-icon-thin-0333_printer" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Imprimir"></i>
                                        <i onclick="window.location.href='<?php echo base_url();?>staff/sale_details_financial/pdf/<?php echo $income['appointment_id'];?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Descargar PDF"></i>
                                        <?php else: ?>


                                        <i onclick="window.open('<?php echo base_url();?>staff/sale_details_financial/email2/<?php echo $income['cart_id'];?>/<?php echo $patient_id;?>');" class="picons-thin-icon-thin-0315_email_mail_post_send" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Enviar recibo por correo"></i>
                                        <i onclick="window.open('<?php echo base_url();?>staff/print_receipt2/<?php echo $income['cart_id'];?>', '_blank');" class="picons-thin-icon-thin-0333_printer" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="Imprimir"></i>
                                        <i onclick="window.location.href='<?php echo base_url();?>staff/sale_details_financial/pdf2/<?php echo $income['cart_id'];?>';" class="picons-thin-icon-thin-0123_download_cloud_file_sync" style="font-size:20px;color:#0176fe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Descargar PDF"></i>
                                        <?php endif;?>
                                        <?php endif;?>
                                    </td>
                                </tr>

        ...
        <div class="modal-body">
            <div class="form-group">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="profile-tile profile-tile-inlined modal-accounting" onclick="window.location.href='<?php echo base_url();?>staff/bank_conciliations/';">
                        ...
                        <div class="col-sm-6">
                            <div class="profile-tile profile-tile-inlined modal-accounting" onclick="window.location.href='<?php echo base_url();?>staff/cash_flows/';">
                                <div class="profile-tile-box">
                                    <div class="tile-controls"></div>

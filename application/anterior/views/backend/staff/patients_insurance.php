        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link <?php  if($page_name == "patients") echo 'current'; ?>" href="<?php echo base_url();?>staff/patients/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0489_storehouse_storage"></i></div> <span>Pacientes de Atenun</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link <?php  if($page_name == "patients_insurance") echo 'current'; ?>" href="<?php echo base_url();?>staff/patients_insurance/">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                ...
                <a class="add-buton pull-right" href="<?php echo base_url().'staff/patients_add/1'?>">+ Agregar
                    Paciente</a>
            </div>
        </div>
        <div class="col-sm-12">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/patients/1'; ?>",
            type: "POST"
        },

    ...
    <div class="os-tabs-w"> 
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/send_email/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0288_mobile_phone_call"></i></div> <span>Enviar correo</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>staff/whatsapp_notifications/">
...
<div id="main-content">
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="card-h">
                    <h5 class="card-caption">Enviar correo electrónico a pacientes u otros usuarios </h5>
                </div>
                <div class="card-b">
                    <form action="<?php echo base_url();?>staff/send_email/send" method="POST" enctype="multipart/form-data" id="formWhatsapp">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="middles">
                                    <label>
                                ...
                                <div id="users" style="display:none">
                                    ...
                                    <div class="form-group">
                                        <label for="simpleinput">Seleccionar usuario</label><span class="error_show" id="errorpat"></span>

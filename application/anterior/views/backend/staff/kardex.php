    ...
    <div class="row">
        <div class="col-md-12 col-ms-12 ">
            <div class="card-widget">
                ...
                <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel_export_kardex/<?php echo base64_encode($ID);?>">EXCEL</a>
...
<div class="modal" id="1remove_product">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>staff/history/remove_medicamento/<?php echo $ID ;?>" method="POST" enctype="multipart/form-data">
                <div class="modal-header" style="background-color:#fff; box-shadow: 0 4px 2px -2px 000;">
                    <h4 style="font-size:21px; color:#565b6b; font-family:'Poppins';"><span style="vertical-align:-3px">

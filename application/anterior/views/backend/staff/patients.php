        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>staff/patients_list/<?php echo base64_encode(0);?>';">
                        Ver</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>staff/patients_list/<?php echo base64_encode($row['insurance_id']);?>';">
                        Ver</div>
                </div>
            </div>
        </div>

        ...
        <div class="todo-sidebar-section" style="border-bottom:0px">
            <div class="todo-sidebar-section-contents">
                <ul class="tasks-list">
                    ...
                    <li class="side-li">
                        <a class="side-items active" href="<?php echo base_url();?>staff/staff_security/<?php echo base64_encode($staff_id);?>/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0705_user_profile_security_password_permissions"></i> Contraseña y seguridad <span class="side-active"></span></a>
                    </li>
                    <li class="side-li">
        ...
        <div class="row">
            ...
            <div class="col-sm-8"><br>
                <div class="tasks-section">
                    <form id="staffPass" action="<?php echo base_url();?>staff/staff/update_password_staff/<?php echo $details['staff_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
...
function remove_auth() {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/staff/remove_auth_staff/<?php echo $staff_id;?>";
        }
    })
}
...
function remove_session() {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/doctors/remove_sessions_staff/<?php echo $staff_id;?>";
        }
    })
}
</script>

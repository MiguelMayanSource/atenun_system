<div class="modal-content animated fadeInDown">
    <div class="modal-header" style="background-color:#fff;">
        <h4 style="font-size:21px; color:#565b6b; font-family:'Poppins';">
            <span style="vertical-align:-3px">Eliminar productos</span>
        </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
    </div>
    <form action="<?php echo base_url();?>staff/inventory_products/product_masive_delete/<?php echo  $param2;?>" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="inventory_id" value="<?php echo $param2;?>">
        ...
        <div class="modal-footer">
            <button type="submit" class="button-confirm">Eliminar</button>
        </div>
    </form>
</div>
<script>
...
function getSubcategory(id){
    $.ajax({
        url: '<?php echo base_url();?>staff/get_subcategories/'+id,
        type: 'POST',

            ...
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        ...
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/my_calendar/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i> Calendario <span class="side-active"></span></a>
                        </li>
                        <li class="side-li">

<aside class="side-nav side-nav-small scroll" id="nav" style="overflow-y: auto !important;">
    ...
    <ul class="side-nav-wrapper">
        ...
        <li class="brand">
            <a href="<?php echo base_url();?>staff/panel/">
        ...
        <li class="movil_brand">
            <a style="text-align:center;" href="<?php echo base_url();?>staff/panel/">
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Tablero">
            <a href="<?php echo base_url();?>staff/panel/" <?php if ($page_name == 'panel'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Usuarios">
            <a href="<?php echo base_url();?>staff/admins/" <?php if ($page_name == 'admins' || $page_name == 'new_admin' || $page_name == 'new_doctor' ||$page_name == 'doctors' || $page_name == 'staff' || $page_name == 'receptionist' || $page_name == 'providers' || $page_name == 'staff_profile' || $page_name == 'admin_profile'  || $page_name == 'doctor_profile'|| $page_name == 'permission_details'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Hospitalizacion">
            <a href="<?php echo base_url();?>staff/stabilitation/" <?php if ($page_name == 'stabilitation' || $page_name == 'stabilitation_details'):?> class="currentPage" <?php endif;?>>
                <i class="iconBox picons-thin-icon-thin-0723_nurse_medicine_hospital_doctor"></i>
                <span class="sideBox-item-name">Hospitalizaci贸n</span>
            </a>
        </li>
        <?php 
         endif;
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Inventario">
            <a href="<?php echo base_url();?>staff/inventory/" <?php if ($page_name == 'inventory' || $page_name == 'categories' || $page_name == 'subcategories' || $page_name == 'equipment' || $page_name == 'supplies' || $page_name == 'history' || $page_name == 'inventory_products') :?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="planes">
            <a href="<?php echo base_url();?>staff/plans/" <?php if ($page_name == 'Puntos y Memebresias' ) :?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Ventas">
            <a href="<?php echo base_url();?>staff/sales_management/" <?php if ($page_name == 'sales_management' || $page_name == 'sales_insurance' || $page_name == 'new_sale' || $page_name == 'sales' || $page_name == 'sale_details' || $page_name == 'pay_appointment'  || $page_name == 'cotizaciones'  ||  $page_name == 'new_cotitation' || $page_name == 'pay_appointment' || $page_name == 'appointments_box'):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Laboratorios">
            <a href="<?php echo base_url();?>staff/samples/" <?php if ($page_name == 'samples'|| $page_name == 'samples_new'  || $page_name == 'laboratory' || $page_name == 'laboratory'  ):?>class="currentPage" <?php endif;?>>
        ...
        <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Rayos X">
            <a href="<?php echo base_url();?>staff/rayx/" <?php if ($page_name == 'rayx'|| $page_name == 'new_rayx'  ):?>class="currentPage" <?php endif;?>>
         ...
         <?php endif; ?>   
          ...
          <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Ultrasonidos">
            <a href="<?php echo base_url();?>staff/ultras/" <?php if ($page_name == 'ultras'|| $page_name == 'new_ultra'  ):?>class="currentPage" <?php endif;?>>
        ...
        <?php        if ($check['view_marketing'] == 1):?>
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Marketing">
                <a href="<?php echo base_url();?>staff/whatsapp/" <?php if ($page_name == 'whatsapp' ):?>class="currentPage" <?php endif;?>>
            ...
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Nueva cita">
                <a style="font-size:15px; padding-left: 20px; text-align:center;" href="<?php echo base_url();?>staff/quote/">
          ...
          <?php if ($check['view_laboratories'] == 1):?>
            <li class="sideBox-item" data-toggle="tooltip" data-placement="right" title="Nueva laboratorio">
                <a style="font-size:15px; padding-left: 20px; text-align:center;" href="<?php echo base_url();?>staff/samples_new_rec/">
                    <div class="third-floated-btn new_app">

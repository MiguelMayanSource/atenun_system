                ...
                <div class="order-details-box">
                    ...
                    <div class="dropdown" style="float:right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:auto; text-align:left;overflow-y:hidden">
                            ...
                            <?php endif; ?>
                            <?php if($details['status'] == 0):?>
                                <a class="dropdown-item" target="_blank" href="<?php echo base_url();?>staff/print_cotizacion/<?php echo $details['sale_id'];?>/<?php echo $details['patient_id'];?>">Imprimir cotización</a>
                    ...
                    <div class="col-sm-12" style="margin-top: 15px;">
                        <div class="order-foot">
                            <div class="row">
                                ...
                                <form action="<?php echo base_url();?>staff/sales/create_special_sale" method="POST">

    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link <?php  if($page_name == "permission_request" || $page_name == "permission_details" ) echo 'current'; ?>" href="<?php echo base_url();?>staff/permission_request/">
...
function aprove_permission_request(id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/permission_request/aprove/" + id;
        }
    })
}
...
function reprove_permission_request(id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/permission_request/reprove/" + id ;
        }
    })
}

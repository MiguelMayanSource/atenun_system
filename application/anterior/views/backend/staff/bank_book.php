...
<div id="main-content">
    <div class="row">
                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            ...
                            <form class="repeater" action="<?php echo base_url();?>staff/bank_book/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
        ...
        <form method="POST" action="<?php echo base_url();?>staff/printFormType/bank_book/" id="frmB" target="">
...
<script type="text/javascript">
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>staff/setChecksBankBook/",
            data: {
                vals: vals,
            },
            dataType: "json",
    ...
    function saveCategory(val, id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>staff/saveCategoryTransfer/",
            data: {
                category: val,
                id: id,
            },

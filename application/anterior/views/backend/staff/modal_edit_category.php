<div class="modal-content animated fadeInDown">
    ...
    <div class="modal-body" style="background-color:#fff;">
        <form action="<?php echo base_url();?>staff/laboratory/create/" method="post" enctype="multipart/form-data" id='formAdd'>
            <div class="widget widget-activity-one">
                <div class="widget-content">
                    ...
                    <form action="<?php echo base_url();?>staff/laboratory/update/<?php echo base64_decode($param2); ?>" method="post" enctype="multipart/form-data" id='form'>
                        <div class="widget widget-activity-one">
                            <div class="widget-content">

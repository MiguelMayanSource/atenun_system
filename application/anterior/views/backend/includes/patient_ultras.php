<h5 class="panel-content-title">Ordenes de Ultrasonidos <?php if($page_name != "patient_profile" ):?><a href="javascript:void(0)" onclick="load_view('new_ultras','ultras',{'patient_id':<?php echo $patient_id; ?>,'origin_id':'<?php echo $origin_id;?>','origin_type':'<?php echo $origin_type;?>'})" style="margin-bottom:10px" class="btn btn-info float-right mb-10">Nueva orden de Ultrasonidos</a><?php endif; ?></h5>
<span class="app-divider2"></span>
<div class="row">
    <div class="col-sm-12">

        <?php 
            $refresh_query  = $this->db->order_by('patient_service_id','desc')->get_where('patient_service',array('patient_id' => $patient_id,'type'=>2));

<h5 class="panel-content-title">Nueva orden de Ultrasonidos</h5>
<span class="app-divider2"></span>
<div class="row">
    <div class="col-md-12"> 
        <form action="<?php echo base_url().'/'.$this->session->userdata('login_type').'/rayx/create/'.$param2;?>" method="post" enctype="multipart/form-data" id='formSample'>
            <div class='row'>
                ...
                <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name='fecha_recibido' vale="<?php echo date('d-m-Y'); ?>">
                    </div>
                </div>
                <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                    <div class="form-group">
                ...
                <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                    <div class="form-group">
                        <a class="btn btn-danger" style="margin-left:10px;" href="javascript:void(0)" onclick="load_view('patient_ultras','ultras',{'patient_id':<?php echo $patient_id;?>,'origin_type':'<?php echo $origin_type;?>','origin_id':<?php echo $origin_id;?>})">Terminar</a>
...
function laboratoriesExamns(value, no) {
    ...
    $.ajax({
        url: '<?php echo base_url().'/'.$this->session->userdata('login_type').'/'; ?>getRayX',
        type: 'POST',
        data: {
            laboratories: value,
        },

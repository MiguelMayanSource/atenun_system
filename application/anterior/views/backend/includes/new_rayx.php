<h5 class="panel-content-title">Nueva orden de Rayos X</h5>
    ...
    <div class="col-md-12"> 
        <form action="<?php echo base_url().'/'.$this->session->userdata('login_type').'/rayx/create/'.$param2;?>" method="post" enctype="multipart/form-data" id='formSample'>
            <div class='row'>
                ...
                <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                    <div class="form-group">
                        <a class="btn btn-danger" style="margin-left:10px;" href="javascript:void(0)" onclick="load_view('patient_rayx','rayx',{'patient_id':<?php echo $patient_id;?>,'origin_type':'<?php echo $origin_type;?>','origin_id':<?php echo $origin_id;?>})">Terminar</a>

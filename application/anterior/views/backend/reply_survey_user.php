...
<body>
    ...
    <div id="form_container">
        <div class="row no-gutters">
            <?php 
                $query = $this->db->get_where('survery_result', array('survey_id' => $survey_id, 'user_id' => $user_id, 'user_type' => $user_type))->num_rows();
                if($query == 0):
            ?>
            <div class="col-lg-4">
                <div id="left_form">
                    <figure><img src="<?php echo base_url();?>public/assets/survey.png" alt="" width="90%"></figure>
                    <h2>¡Gracias <span><?php echo $this->accounts_model->short_name($user_type, $user_id);?>!</span></h2>
            ...
            <div class="col-lg-8">
                <div id="wizard_container">
                    ...
                    <form id="wrapped" method="post" action="<?php echo base_url();?>survey/confirm_user">
                        ...
                        <div id="middle-wizard">
                            ...
                            <div class="submit step" id="end">
                                <div class="summary">
                                    <div class="wrapper">
                                        <h3>¡Gracias por tu tiempo<br><span><?php echo $this->accounts_model->short_name($user_type, $user_id);?></span>!</h3>

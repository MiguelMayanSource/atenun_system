...
class Staff extends CI_Controller
{
    function __construct()
    {
        ...
        $this->check = unserialize($this->accounts_model->getPermissionsRole($this->db->get_where('staff',array('staff_id'=> $this->session->userdata('login_user_id')))->row()->role_id));
    ...
    function notifications($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'delete')
        {
            ...
            redirect(base_url() . 'staff/notifications/', 'refresh');
        }
        if($param1 == 'mark_read')
        {
            $data['read_status'] = 1;    
                ...
                if(count($query2) > 0)
                {
                    foreach ($query2 as $row2) 
                    {
                        ...
                        $html  .= ' bg-size" style="background-image: url('.$this->accounts_model->get_photo($type, $row2['staff_id']).'); background-size: cover; background-position: center center; display: block;">
                          ...
                          <div class="contact-action">
                            <a class="icon-btn btn-outline-primary btn-sm button-effect" href='.base_url().'staff/chat_messages/'.$row2['username'].'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg></a>
                          </div>
                        </div>
                      </li>';
                ...
                if(count($query3) > 0)
                {
                    foreach ($query3 as $row3) 
                    {
                        ...
                        $html  .= ' bg-size" style="background-image: url('.$this->accounts_model->get_photo($type, $row3['patient_id']).'); background-size: cover; background-position: center center; display: block;">
                          ...
                          <div class="contact-action">
                            <a class="icon-btn btn-outline-primary btn-sm button-effect" href='.base_url().'staff/chat_messages/'.$row3['username'].'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg></a>
                          </div>
                        </div>
                      </li>';
    ...
    */
    ...
    function print_prescription($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/staff/print_prescription', $page_data);
    }
    ...
    function print_solicitud($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/staff/print_solicitud', $page_data);
    }
    ...
    function print_financial_report($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/staff/print_finance_reports', $page_data);
    }
    ...
    function print_inventory_report($param1 = '', $param2 = '')
    {
        ...
        $this->load->view('backend/staff/print_inventory_reports', $data);
    }
    ...
    function subscription($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/confirmed/'.$data['code'], 'refresh');
        }
        if($param1 == 'cancel'){
            ...
            redirect(base_url() . 'staff/subscription/', 'refresh');
        }
 ...
 function update_discount_table_est($stabilitation_id)
    ...
    function sale_details($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if($param1 == 'email')
        {
            ...
            redirect(base_url() . 'staff/sale_details/'.base64_encode($sale_id), 'refresh');
        }
    ...
    function combos($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/combos/', 'refresh');
        }
        ...
        if($param1 == 'set')
        {
            ...
            redirect(base_url() . 'staff/solicitudes/', 'refresh');
        }
    ...
    function purchases($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create_solicitud')
        {
            ...
            redirect(base_url() . 'staff/purchases/', 'refresh');
        }
    ...
    {
        echo $this->inventory_model->get_product_press($product_id);
    }
    ...
    function subcategories($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/subcategories/', 'refresh');
        }
    ...
    function sales($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create_cot')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Venta agregada correctamente.");
            redirect(base_url() . 'staff/sales/'.base64_encode(1), 'refresh');
        }
        ...
        if($param1 == 'create_sale_insurance')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Venta agregada correctamente.");
            redirect(base_url() . 'staff/sales_insurance/', 'refresh');
    ...
    function box($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'close_box')
        {
            ...
            redirect(base_url() . 'staff/sales_management/', 'refresh');
        }
   ...
   function appointment_details_card($param1 = '', $param2 = '')
            ...
            {                        
                ...
                <div class="alert alert-white" style="margin-top: 42px;">
                        <span style="display:block;font-weight:bold;font-size:18px;font-family:"Poppins", sans-serif">Detalles de la cita:</span>
                            ...
                            if($this->check['access_appointments'] == 1)
                                $html .= ' <a class="btn btn-success" href="'.base_url().'staff/appointment_details/'.$param1.'"><i class="picons-thin-icon-thin-0133_arrow_right_next"></i> Ingresar a la cita</a>';
            ...
            <div class="alert alert-white" style="margin-top: 42px;">
                    <span style="display:block;font-weight:bold;font-size:18px;font-family:"Poppins", sans-serif">Detalles de la cita:</span>
                        ...
                        <div class="pipeline-item">
                           ...
                           if($this->check['access_appointments'] == 1)  
                                $html .= ' <a class="btn btn-success" href="'.base_url().'staff/appointment_details/'.base64_encode($param1).'"><i class="picons-thin-icon-thin-0133_arrow_right_next"></i> Ingresar a la cita</a>';
        ...
        function appointment_patients($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Cita agendada correctamente.");
            redirect(base_url() . 'staff/patients/profile/'.$param2, 'refresh');
        }
        $page_data['id_']   = $param1;
    ...
    function chat($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if($param1 == 'delete_single')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Mensaje eliminado correctamente.");
            redirect(base_url() . 'staff/messages/'.$param3, 'refresh');
        }  
    ...
    function appointments($param1 = '', $param2 = '') 
    {
        ...
        if($param1 == 'delete_calendar')
        {
            ...
            redirect(base_url() . 'staff/calendar/', 'refresh');
        }
 ...
 public function stabilitation($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url() . 'staff/stabilitation/', 'refresh');
        }
    ...
    function patients($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/patient_profile/'.$patient_id, 'refresh');
        }
        if($param1 == 'update')
        {
            $this->accounts_model->update_patient($param2);
    ...
    function memberships($param1 = '') {
        ...
        if($param1 == 'create_membership')
        {
            ...
            redirect(base_url().'staff/memberships', 'refresh');
        }
    ...
    function membership_details($param1 = '') {
        $this->session_login();
    ...
    function points($param1 = '') {
        ...
        if($param1 == 'set')
        {
            ...
            redirect(base_url().'staff/points', 'refresh');
        }
    ...
    function doctors($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'doctor_auth_link'){
            ...
            redirect(base_url() . 'staff/doctor_security/'.base64_encode($param2), 'refresh');
        }
        if($param1 == 'remove_auth'){
            ...
            redirect(base_url() . 'staff/my_security/', 'refresh');
        }
        ...
        if($param1 == 'update_profile')
        {
            ...
            redirect(base_url() . 'staff/my_profile/', 'refresh');
        }
        ...
        if($param1 == 'update_doctor_modules')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Datos actualizados correctamente.");
            redirect(base_url() . 'staff/doctor_permissions/'.base64_encode($param2).'/', 'refresh');
        }
        ...
        if($param1 == 'update_profile_modules')
        {
            $this->accounts_model->update_doctor_modules($param2);
            $this->session->set_flashdata('flash_message' , "Datos actualizados correctamente.");
            redirect(base_url() . 'staff/my_permissions/', 'refresh');
        }
    ...
    function admins($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'doctor_auth_link'){
            $this->security_model->updateSecret(base64_decode($param2));
            $this->session->set_flashdata('flash_message' , "Autenticación activada correctamente.");
            redirect(base_url() . 'staff/admin_security/'.base64_encode($param2), 'refresh');
        }
        ...
        if($param1 == 'update_doctor_modules')
        {
            $this->accounts_model->update_doctor_modules($param2);
            $this->session->set_flashdata('flash_message' , "Datos actualizados correctamente.");
            redirect(base_url() . 'staff/admin_permissions/'.base64_encode($param2).'/', 'refresh');
        }
        ...
        if($param1 == 'delete')
        {
            ...
            redirect(base_url() . 'staff/admins/', 'refresh');
        }
    ...
    function permission_request($param1 = '',$param2 = '')
    {
        ...
        if($param1 == 'create'){
            ...
            redirect(base_url() . 'staff/permission_request/', 'refresh');
    ...
    {
         $this->session_login();
        redirect(base_url() . 'staff/appointments/'.base64_encode($this->input->post('date')), 'refresh');
    }
    ...
    function staff($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'new')
        {
            ...
            redirect(base_url() . 'staff/receptionist/', 'refresh');
            
            if($this->input->post('category') == 3)
            redirect(base_url() . 'staff/providers/', 'refresh');
            
            if($this->input->post('category') == 4)
            redirect(base_url() . 'staff/sellers/', 'refresh');
            
            if($this->input->post('category') == 5)
            redirect(base_url() . 'staff/accountants/', 'refresh');
        ...
        if($param1 == 'update_staff_modules')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Datos de usuario actualizados correctamente.");
            redirect(base_url() . 'staff/staff_permissions/'.base64_encode($param2).'/', 'refresh');
        }
    ...
    function rooms($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/rooms/', 'refresh');
        }
    ...
    function surgery_room($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/surgery_room/', 'refresh');
        }
    ...
    */
    ...
    function patient_files($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'delete')
        {
            ...
            redirect(base_url() . 'staff/patient_files/'.base64_encode($patient_id), 'refresh');
        }
   ...
   function laboratory($param1 = '', $param2 = '')
   {
    $this->session_login();
       ...
       if($param1 == "create")
       {
           ...
           if($response == 1)
           {
               redirect(base_url().'staff/laboratory/', 'refresh'); 
           }
       }
       if($param1 == "update")
       {
  ...
  function laboratory_results($param1 = '', $param2 = '')
  {
      ...
      if($param1 == "save")
      {
            ...
            redirect(base_url().'staff/samples/' , 'refresh');
    ...
    function rayx($param1 = '', $param2 = '', $param3 = '')
        {
            ...
            if($param1 == "edit")
            {
                ...
                if($response == 1)
                {
                    redirect(base_url().'staff/samples/'.base64_encode($this->input->post('category_id')), 'refresh');
                }
  ...
  ////////////////////////////////
        ...
        function samples($param1 = '', $param2 = '', $param3 = '')
        {
            ...
            if($param1 == "delivery")
            {
                ...
                if($response == 1)
                {
                    redirect(base_url().'staff/samples/'.base64_encode(1), 'refresh');
                }
            }
        ...
        function  getPatients($param1= ''){
            ...
            function getDiagnostico(){
                ...
                foreach($samples->result_array() as $sa){
                    ...
                    if($sa['report'] != ""){
                    $html.='     <td>
                                <a href="'.base_url().'staff/sample_diagnostic/'.base64_encode($sa['sample_id']).'" target="_blank">
  ...
  //////////////////////////////////////////
    function rayos_x($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Laboratorio agregado correctamente.");
            redirect(base_url() . 'staff/rayos_x/', 'refresh');
        }
    ...
    function product_estb($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Laboratorio agregado correctamente.");
            redirect(base_url() . 'staff/product_estb/', 'refresh');
        }
    ...
    */
        ...
        foreach($query->result_array() as $row)
        {
            ...
            $html_table .= '
                <tr style="font-size:14px;" class="">
                    ...
                    <td> <a href="'.base_url().'staff/history/'.$row['product_id'].'" style="color:black;">'.$row['name'].' </a></td>
                    <td>'.$row['code'].'</td>
    ...
    function my_notifications($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'delete')
        {
            ...
            $this->db->delete('notification');
            $this->session->set_flashdata('flash_message' , "Notificación eliminada correctamente.");
            redirect(base_url() . 'staff/my_notifications/', 'refresh');
        }
        if($param1 == 'mark_read')
        {
            $data['read_status'] = 1;    
    ...
    function kardex($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'add_medicamento')
        {
            ...
            redirect(base_url() . 'staff/history/'.$param2, 'refresh');
        }
    ...
    function equipment($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            redirect(base_url() . 'staff/equipment/', 'refresh');
        }
    ...
    function supplies($param1 = '', $param2 = '')
    {
        ...
        if($param1 == 'create')
        {
            ...
            $this->session->set_flashdata('flash_message' , "Equipo agregado correctamente.");
            redirect(base_url() . 'staff/supplies/', 'refresh');
        }
    ...
    function entry_staff($param1 = '', $param2 = '')
    {
        ...
        redirect(base_url().'staff/entry_view/'. $timestamp,'refresh');  
    ...
    function nomenclature($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'staff/nomenclature/', 'refresh');
        }
    ...
    function departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'staff/departure_edit/'.base64_encode($response), 'refresh');
        }
        if ($param1 == 'edit') {
            $response = $this->crud_model->editDeparture();
            $this->session->set_flashdata('flash_message' , "Partida editada exitosamente");
            redirect(base_url().'staff/departures/', 'refresh');
        }
    ...
    function bank_conciliation($param1 = '', $param2 = '') 
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'staff/bank_conciliation_detail/'.base64_encode($id), 'refresh');
        }
    ...
    function cash_flow($param1 = '', $param2 = '') 
    {
        ...
        if ($param1 == 'save') {
            ...
            redirect(base_url().'staff/cash_flow_detail/'.base64_encode($id), 'refresh');
        }
    ...
    function closing_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'staff/closing/', 'refresh');
        }
    ...
    function opening_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url().'staff/opening/', 'refresh');
        }
    ...
    function adjust_departure($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', "Partida de cierre creada correctamente");
            redirect(base_url().'staff/adjust/', 'refresh');
        }
    ...
    function banks($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/banks/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_accounts($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/bank_accounts/'.$param2, 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function currencies($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/currencies/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_checks($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/bank_checks/', 'refresh');
        }
        if ($param1 == 'edit') {
    ...
    function bank_transfers($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/bank_transfers/', 'refresh');
        }
    ...
    function account_types($param1 = '', $param2 = '', $param3 = ''){
        ...
        if ($param1 == 'new') {
            ...
            redirect(base_url().'staff/account_types/', 'refresh');
        }
        if ($param1 == 'edit') {

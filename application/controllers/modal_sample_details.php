...
<form action="<?php echo base_url();?>admin/samples/delivery/<?php echo $param2; ?>" method="post" enctype="multipart/form-data" id='formGroup'>
    <div class="widget widget-activity-one">
                ...
                <div class='container row'>
                    <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                        <div class="form-group">
                            <p><b> Paciente: </b><a href="mailto:'.$dev['email'].'"><?php echo $this->crud_model->getPatient($row['patient_id']);?></a></p>
                            <p> <b>Edad: </b><?php echo $this->crud_model->getPatientAge($row['patient_id']);?> <b>Genero: </b><?php echo $this->crud_model->getPatientGender($row['patient_id']);?></p>
                            <p> <b>Teléfono: </b><?php echo $this->crud_model->getPatientPhone($row['patient_id']);?></p>
                            <p> <b>Doctor: </b><a href="mailto:'.$dev['email'].'"><?php echo $this->crud_model->getName('doctor',$row['doctors_id']); ?><?php if($row['several_doctors']!=""):?>,<?php echo $row['several_doctors'];?><?php endif; ?></a> </p>
                            ...
                            <div class='' style='display: inline-flex;'>
                                <?php 
                                            ...
                                            if($row['status_delivery'] == 0 ){
                                                $acciones.='<a  style="color: black;font-size: 22px;padding: 12px;" title="Entregar"  href="javascript:;" onclick="showModal(\''.base_url().'modal/popup/modal_delivery/'.$row['sample_id'].'\')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-send"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg></a>';
                                            }
        ...
        <div class="modal-footer">
            ...
            <button class="btn btn-primary " id='addSample'>Guardar</button>
        </div>
    </div>
</form>
<?php endforeach; ?>
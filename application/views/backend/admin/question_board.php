...
<div id="main-content">
    <div class="card-widget">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url();?>admin/question_board/<?php echo $codigo;?>/">Detalles</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url();?>admin/questions/<?php echo $codigo;?>">Preguntas</a>
            </li>
            <li class="nav-item">
        ...
        <div class="content-box">
            <div class="card-h">
                <h3 class="card-caption"> <a href="<?php echo base_url();?>admin/surveys/"><i class="picons-thin-icon-thin-0159_arrow_back_left" style="font-size:19px"></i></a>
            ...
            <div class="tasks-section">
                ...
                <div class="tasks-list-w">
                    <form action="<?php echo base_url();?>admin/surveys/update/<?php echo $codigo;?>" method="post">
                        <div class="row">
                            <div class="col-sm-12">

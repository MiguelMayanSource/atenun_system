             ...
             <div class="todo-sidebar-section" style="border-bottom:0px">
                 ...
                 <div class="todo-sidebar-section-contents">
                     <ul class="tasks-list">
                         ...
                         <li class="side-li">
                             <a class="side-items active" href="<?php echo base_url();?>admin/my_permissions/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0015_fountain_pen"></i> Permisos <span class="side-active"></span> </a>
                         </li>
                     </ul>
                 </div>
             </div>
         ...
         <div class="row">
             <div class="col-sm-9" style="float: none; margin: 0 auto;">
                 ...
                 <div class="col-sm-12">
                     ...
                     <form action="<?php echo base_url();?>admin/doctors/update_profile_modules/<?php echo $details['admin_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">

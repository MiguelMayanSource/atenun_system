    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link <?php  if($page_name == "patients_insurance") echo 'current'; ?>" href="<?php echo base_url();?>admin/patients_insurance/">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                ...
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/patients_add/1'?>">+ Agregar
                    Paciente</a>
            </div>
        </div>
        <div class="col-sm-12">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/patients/1'; ?>",
            type: "POST"
        },

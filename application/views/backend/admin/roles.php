                ...
                <table class="table table-padded" id="user_data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url().'admin/permissions/'.base64_encode($rl['role_id']);?>">Ver</a></td>
                            <td>
    ...
    function deactivateRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/roles/deactivate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function activateRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/roles/activate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function deleteRole(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/roles/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

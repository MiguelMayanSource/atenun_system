...
<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    <?php 
            ...
            if (count($dats) == 0){
            ?>
    <form id="formGO" action="<?php echo base_url();?>admin/patients/create_obstetric/<?php echo $param2;?>" method="post">
        <?php }
	         else {
            ?>
        <form id="formGO" action="<?php echo base_url();?>admin/patients/update_obstetric/<?php echo $param2;?>" method="post">
            <?php } ?>

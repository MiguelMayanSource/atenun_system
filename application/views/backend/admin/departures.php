    ...
    <div class="row">
        <div class="col-12">
            <div class="title-header">
                ...
                <a class="add-buton" href="<?php echo base_url();?>admin/nomenclature/">Nomenclatura</a>
            </div>
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <form method="post" action="<?php echo base_url();?>admin/departures/">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <div class="">
                                    <a class="btn btn-info" href="<?php echo base_url();?>admin/departure">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary" href="<?php echo base_url().'admin/departure_edit/'.base64_encode($pt['departure_id']);?>">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                &nbsp;
                                                &nbsp;
                                                <?php endif;?>
                                                <a class="btn btn-secondary" href="<?php echo base_url().'admin/policy_departure/'.base64_encode($pt['departure_id']);?>">
    ...
    function desactivarPartida(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/departures/deactivate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function activarPartida(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/departures/activate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function eliminarPartida(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/departures/delete/",
                    data: {
                        id: id,
                    },
                    dataType: "json",

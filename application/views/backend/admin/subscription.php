    ...
    <div class="app-email-w" style="background-color:#f6f7f8;">
        <div class="app-email-i">
            ...
            <div class="pageContent2">
                <form action="<?php echo base_url();?>admin/subscription/create" method="POST">
                    <div class="row">
                        <div class="col-sm-12">
                            <?php if($this->crud_model->checkSubscription()->num_rows() > 0):?>
                            <div class="alert alert-danger">
                                Tienes una factura pendiente de pago, haz click <a href="<?php echo base_url();?>admin/confirmed/<?php echo $this->crud_model->checkSubscription()->row()->code;?>/pg/">aquí</a> para más información.
                            </div>
                            <?php endif;?>
                        </div>
                        <div class="col-md-8">

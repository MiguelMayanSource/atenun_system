    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <?php endif;?>
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/reports/">
        ...
        <div class="col-sm-12">
            <div class="title-header">
                <div class="card-widget">
                    ...
                    <form action="<?php echo base_url();?>admin/reports" method="POST" id="filter_form">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/activities/'.$_id.'/'.$type; ?>",
            type: "POST"
        },

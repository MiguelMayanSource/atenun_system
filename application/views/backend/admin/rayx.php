...
<div id="main-content"> 
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title">Ordenes de rayos X</h3>
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/patient_service_add/1'?>">+ Nueva orden</a>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="row">
    <div class="col-sm-12">
        ...
        <?php 
            $refresh_query  = $this->db->order_by('patient_service_id','desc')->get_where('patient_service',array('type'=>1));
        ...
        <div class="col-sm-12"><br>
            <center>
                <h5 class="poppins">Aún no hay ordenes de Rayos X</h5><br><img src="<?php echo base_url() ?>public/uploads/medicamentos.svg" style="max-width:20%;">
            </center>
        </div>
        <?php endif; ?>
    </div>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/patient_service/1'; ?>",
            type: "POST"
        },

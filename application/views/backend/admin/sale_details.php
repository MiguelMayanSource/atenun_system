                    ...
                    <div class="dropdown" style="float:right">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:auto; text-align:left;overflow-y:hidden">
                            <?php if($details['status'] != 0):?>
                                <a class="dropdown-item" target="_blank" href="<?php echo base_url();?>admin/print_receipt/<?php echo $details['invoice'];?>/<?php echo $details['patient_id'];?>">Imprimir</a>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="send_email(<?php echo $details['invoice'];?>,'<?php echo $details['patient_id'];?>')">Enviar por correo</a>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="send_whatsapp(<?php echo $details['invoice'];?>,'<?php echo $details['patient_id'];?>')">Enviar por whatsapp</a>
                            <?php endif; ?>
                            <?php if($details['status'] == 0):?>
                                <a class="dropdown-item" target="_blank" href="<?php echo base_url();?>admin/print_cotizacion/<?php echo $details['sale_id'];?>/<?php echo $details['patient_id'];?>">Imprimir cotización</a>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="send_email_cot(<?php echo $details['sale_id'];?>,'<?php echo $details['patient_id'];?>')">Enviar cotiación por correo</a>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="send_whatsapp_cot(<?php echo $details['sale_id'];?>,'<?php echo $details['patient_id'];?>')">Enviar cotización por whatsapp</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif;?>
                    ...
                    <div class="col-sm-12" style="margin-top: 15px;">
                        <div class="order-foot">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <?php if($details['status'] != 0):?><h5 class="order-section-heading">Resumen de la venta</h5><?php endif; ?>
                                ...
                                <form action="<?php echo base_url();?>admin/sales/create_special_sale" method="POST">
...
function send_email(sale_id, element_id2) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/sale_details/email/" + sale_id + '/' + element_id2;
        }
    })
}
</script>
...
function send_email_sin_receta(sale_id, element_id2) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/sale_details/email2/" + sale_id + '/' + element_id2;
        }
    })
}

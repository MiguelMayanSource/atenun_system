...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title">Proveedores registrados</h3>

                <!-- <a class="add-buton pull-right" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_new_staff/2');">+ Agregar proveedor</a>-->
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/provider_new/';?>">+ Agregar proveedor</a>
            </div>
        </div>
                    ...
                    <div class="tile-controls">
                        <div class="tile-settings os-dropdown-trigger">
                            ...
                            <div class="os-dropdown">
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url();?>admin/provider_profile/<?php echo base64_encode($row['staff_id']);?>/"><i class="picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span>Perfil</span></a>
                                    </li>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <center><br>
                    <h4 style="text-align:center;color:#4d4a81;margin-top:2%;">Aún no se tiene proveedores registrados</h4>
                    <br>

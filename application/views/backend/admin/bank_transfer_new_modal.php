...
<div class="modal-content animated fadeInDown">
    <form action="<?php echo base_url();?>admin/bank_transfers/new/" method="POST">
...
<script type="text/javascript">
    ...
    function otherAccounts() {
        ...
        if (id != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/getOtherBankAccounts/",
                data: {
                    id: id,
                    property: property,
                },
    ...
    function checkBalance() {
        ...
        if (id != '' && amount != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/checkBalanceBankAccount/",
                data: {
                    id: id,
                    amount: amount,
                },

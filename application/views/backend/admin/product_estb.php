    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>admin/inventory_iv/">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>admin/rayos_x/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0827_body_weight_fitness_health_fat"></i></div><span>Rayos X</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/product_estb/">
    ...
    <div class="row ">
        <div class="col-sm-12">
            <div class="title-header"><br>
                <h3 class="module-title">Productos de estabilización</h3>
                <a class="add-buton pull-right" href="javascript:void(0);" data-toggle="modal" data-target="#123myModal">+ Nuevo Producto</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card-b">
...
<div class="modal" id="123myModal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>admin/producto_estb/create" method="POST">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/product_estb'; ?>",
            type: "POST"
        },
...
function delete(laboratory_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/laboratories/delete/" + laboratory_id;
        }
    })
}
</script>
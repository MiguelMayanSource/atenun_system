    ...
    <div class="app-email-i">
        <div class="ae-side-menu">
            ...
            <ul class="ae-main-menu">
                <li>
                    <a href="<?php echo base_url();?>admin/settings/"><span>Ajustes</span></a>
                </li>
                <li>
                    <a href="<?php echo base_url();?>admin/subscription/"><span>Suscripción</span></a>
                </li>
                <li class="active">
                    <a href="<?php echo base_url();?>admin/prescriptions/"><span>Recetas</span></a>
                </li>
                <li>
                    <a href="<?php echo base_url();?>admin/forms/"><span>Formularios</span></a>
                </li>
            </ul>
        </div><br>

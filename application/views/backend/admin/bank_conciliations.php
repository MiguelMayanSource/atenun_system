    ...
    <div class="row">
        <div class="col-12">
            <div class="title-header">
                ...
                <a class="add-buton" href="<?php echo base_url();?>admin/cash_flows/">Flujo de efectivo</a>
            </div>
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="btn-toolbar mb-2">
                                <div class="">
                                    <a type="button" class="btn btn-info" href="<?php echo base_url();?>admin/bank_conciliation/">
                            ...
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-secondary" href="<?php echo base_url().'admin/bank_conciliation_detail/'.base64_encode($cl['bank_conciliation_id'])?>" >
    ...
    function eliminarConciliación(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>admin/bank_conciliations/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

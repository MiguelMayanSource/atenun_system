...
<div class="todo-app-w">
    ...
    <div class="todo-content" style="margin-bottom:20%">
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="<?php echo base_url();?>admin/patient_profile/<?php echo base64_encode($patient_id);?>" class="btn btn-info"><i class="picons-thin-icon-thin-0132_arrow_back_left"></i>
                    Regresar</a><br><br>
            </div>
            <div class="col-sm-12">

                ...
                <div class="todo-sidebar-section" style="border-bottom:0px">
                    <div class="todo-sidebar-section-contents">
                        <ul class="tasks-list">
                            ...
                            <li class="side-li">
                                <a class="side-items active" href="<?php echo base_url();?>admin/my_notifications/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0543_world_earth_worldwide_location_travel"></i> Notificaciones <span class="side-active"></span></a>
                            </li>
...
function mark_read(notification_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/my_notifications/mark_read/" + notification_id;
        }
    })
}
...
function delete_this(notification_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/my_notifications/delete/" + notification_id;
        }
    })
}
    </script>
    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>admin/solicitudes/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0014_notebook_paper_todo"></i></div>
                        <span>Pedidos</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/services/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0813_heart_vitals_pulse_rate_health"></i></div>
                        <span>Servicios</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>admin/equipment/">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>admin/supplies/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0172_structure_menu_submenu_navigation"></i></div>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/services'; ?>",
            type: "POST"
        },
...
<div class="modal" id="1new_product">
    <div class="modal-dialog modal-dialog-centered modal-big">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>admin/services/create" method="POST" enctype="multipart/form-data">
...
function delete_inventory(product_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/services/delete/" + product_id;
        }
    })
}
</script>
                ...
                <div class="_body_ztkcf7">
                    ...
                    <div class="_body-prescription-info_ztkcf7">
                        ...
                        <div style="width: 33%;  margin: 50px 0 30px auto;  padding-top: 5px; text-align: center;  font-size: 14px;">
                            ...
                            <img src="<?php echo base_url();?>public/uploads/doctor_signature/<?php echo $this->db->get_where('admin', array('admin_id' => $doctor_id))->row()->signature; ?>" alt="<?php echo $this->db->get_where('clinic', array('clinic_id' => $this->session->userdata('current_clinic')))->row()->name;?>"
                                 style="width:40%; margin-bottom: 5px;"><br>
                            <?php }?>

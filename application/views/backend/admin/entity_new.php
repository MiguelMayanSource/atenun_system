            ...
            <div class="col-xl-8 col-lg-8 col-sm-12" style="float: none; margin: 0 auto;">
                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                    <h4 class="todo-content-header">
                        <i class="batch-icon-arrow-right"></i><span> Ingresar nueva entidad</span>
                    </h4>
                </div>
            </div>
        </div><br>
        <form action="<?php echo base_url();?>admin/providers/new_single/" method="POST" enctype="multipart/form-data" id="formS">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-sm-12" style="float: none; margin: 0 auto;">
                    <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc;">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group m-b-15">
                                    ...
                                    <textarea type="text" style="border: 1px solid #198cff8f;" name="address" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group m-b-15">

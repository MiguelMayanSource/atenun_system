<ul class="tasks-list">
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="appointments_box"){ echo 'checked'; } ?> name="type" type="radio" class="custom-control-input" id="today" onclick="window.location.href='<?php echo base_url();?>admin/appointments/';">
    ...
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="pending_payment"){ echo 'checked'; } ?> name="type" type="radio" class="custom-control-input" id="customCheck2" onclick="window.location.href='<?php echo base_url();?>admin/pending_payment/';">

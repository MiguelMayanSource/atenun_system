...
<div class="modal-content animated fadeInDown">
    <form action="<?php echo base_url();?>admin/bank_checks/edit/" method="POST">
...
<script type="text/javascript">
    ...
    function validarChequeEdit() {
        ...
        if (id != '' && no != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/verifyNoCheckEdit/",
                data: {
                    id: id,
    ...
    function buscarRubros(buscar) {
        ...
        if (buscar != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/searchNomenclatureSelect/",
                data: {
                    search: buscar,
                },
                dataType: "json",

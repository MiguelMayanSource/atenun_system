...
<div class="modal-content animated fadeInDown">
    <form action="<?php echo base_url();?>admin/nomenclature/edit_nomen/" method="POST">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="code" value="<?php echo $nomen['code'];?>" required onblur="searchNomenEdit(this.value)" />
...
<script type="text/javascript">
    ...
    function searchNomenEdit(code) {
        if (code != "" && code != codigo){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>admin/searchNomenEdit/",
                data: {
                    id: id,
                    code: code,
                },

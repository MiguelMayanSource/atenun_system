...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title">Recepcionistas registrados</h3>

                <!--<a class="add-buton pull-right" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_new_staff/2');">+ Agregar Recepcionistas</a>-->
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/staff_new/2';?>">+ Agregar Personal</a>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    <div class="tile-controls">
                        <div class="tile-settings os-dropdown-trigger">
                            ...
                            <div class="os-dropdown">
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url();?>admin/staff_profile/<?php echo base64_encode($row['staff_id']);?>/"><i class="picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span>Perfil</span></a>
                                    </li>
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>admin/messages/<?php echo $row['username'];?>';">
                        Mensaje</div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title">Recepcionistas registrados</h3>
                <!-- <a class="add-buton pull-right" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_new_staff/2');">+ Agregar Recepcionista</a>-->
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/staff_new/2';?>">+ Agregar Personal</a>
            </div>
        </div>
        <div class="col-sm-12">
            <div class="card-box">
                <center><br>
                    <h4 style="text-align:center;color:#4d4a81;margin-top:2%;">Aún no se tiene Recepcionistas registrados</h4>
                    <br>
...
function delete_staff(staff_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/staff/delete/" + staff_id;
        }
    })
}

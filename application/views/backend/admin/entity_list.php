    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title"><?php echo $entity_id == 0?'Todos los pacientes':'Pacientes de la Entidad: '.$this->db->get_where('entity',array('entity_id'=>$entity_id))->row()->first_name;?></h3>
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/patients_add/'.base64_encode($entity_id); ?>">+ Agregar
                    Paciente</a>
            </div>
        </div>
        <div class="col-sm-12">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'admin/getTable/patientsEntity/'.$entity_id; ?>",
            type: "POST"
        },

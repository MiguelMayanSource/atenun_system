...
<?php   
    ...
    $vs = $this->db->order_by('vital_sign_id', 'desc')->limit(1)->get_where('vital_sign',array('patient_id'=>$det['patient_id']))->row_array();
?>
<script>
                            ...
                            <div class="patient-info">
                                <div class="profile-tile-box">
                                    ...
                                    <div class="pt-user-last">
                                        <a href="<?php echo base_url().$this->session->userdata('login_type'); ?>/patient_profile/<?php echo base64_encode($det['patient_id']); ?>" style="color:black;text-decoration:none;"><?php echo $this->accounts_model->get_name('patient',$det['patient_id']);?></a>.
                                    </div>
                                    <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 text-left ">
                                                ...
                                                <div class="col-sm-12 row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <b>Circunferencia abdominal:</b> <?php echo  $vs['cb'] ?>
                                                    </div>
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 text-center mt-10">
                                                <center><span class="app-divider"></span></center>
                                                <a class="btn btn-lg btn-primary" href="<?php echo base_url().$this->session->userdata('login_type')?>/appointment/finish_appointment/<?php echo $id_; ?>"> Finalizar cita</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="col-sm-8">
            ...
            <div style="width:auto">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " data-toggle="tab" href="#c-appointments" id="d-appointments">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 48 48">
                                <g fill="currentColor">
                                    <path d="M11 30a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2H12a1 1 0 0 1-1-1Zm1 4a1 1 0 1 0 0 2h14a1 1 0 1 0 0-2H12Zm2-13v-3h2v3h3v2h-3v3h-2v-3h-3v-2h3Z" />
                                    <path fill-rule="evenodd" d="M15 6a3 3 0 0 0-3 3H9a3 3 0 0 0-3 3v27a3 3 0 0 0 3 3h20a3 3 0 0 0 3-3V12a3 3 0 0 0-3-3h-3a3 3 0 0 0-3-3h-8Zm8 6a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1h-8a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h8Zm-11-1a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3h3a1 1 0 0 1 1 1v27a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V12a1 1 0 0 1 1-1h3Zm24 6a3 3 0 1 1 6 0v20.303l-3 4.5l-3-4.5V17Zm3-1a1 1 0 0 0-1 1v2h2v-2a1 1 0 0 0-1-1Zm0 22.197l1-1.5V21h-2v15.697l1 1.5Z" clip-rule="evenodd" />
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane container fade show active " id="c-evolucion">
                  ...
                  <!-- Receta meédica -->
                <div class="tab-pane container fade" id="c-appointments">
                    <div class="card-widget" id="evol" style="margin-top:15px;border: 1px solid #c6c6cc;">
                        <?php
                            include_once(dirname(__DIR__, 1).'/includes/patient_appointments2.php');
                        ?>
                    </div>
                </div>
                <!-- Receta meédica -->
...
function print_history() {
                ...
                ventanaImpresion.document.write(`<html><head><title>Contenido para Imprimir</title></head><style>
                    @media print {
                        body,
                        page[size="A4"] {
                            margin: 0;
...
function putVitalSings() {
    ...
    $page.append(`
            <span><b>Fecha: </b> ${new Date().toISOString().split('T')[0]} </span>
            <br>
            <br>
            <span style="margin-bottom:10px; display:block;font-weight:bold;font-size:16px;font-family:'Poppins', sans-serif">Últimos signos vitales registrados</span>
                <div >
                    <b>Peso:</b> <?php echo  $vs['w'] ?> (lbs)
                </div>
                <div >
    ...
    if ($page.next(".page").length == 0 && lastChildPos >= 1021) {
...
function checkPage($page, e) {
    ...
    } else if ($page.next(".page").length > 0 && lastChildPos >= 1021) {
...
function save() {
    var content = $('.appointmet_observations').html(); // orig
    $.ajax({
        type: 'POST',
        url: url + 'patients/save_history/' + <?php echo $det['appointment_id'];?>,
        data: {
            history: content,
        },

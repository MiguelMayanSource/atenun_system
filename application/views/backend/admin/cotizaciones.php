    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title"><a class="" href="<?php echo base_url().$this->session->userdata('login_type');?>/sales_management"><i class="picons-thin-icon-thin-0132_arrow_back_left"></i></a> Control de cotizaciones;</h3>
                <br>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card-b">
                <form class="mb-15" id="search-form" action="<?php echo base_url();?>admin/cotizaciones/Mw==" method='POST'>
                    <div class="row mb-6">
                ...
                <a class="add-buton " href="<?php echo base_url().$this->session->userdata('login_type'); ?>/new_cotitation" >+ Nueva cotización</a>
                <?php endif; ?>
                <br>
                <br>
                <br>
...
$(document).ready(function() {
    ...
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/cotizaciones/'.$sales_status; ?>",
            type: "POST",
            data: function(d) {
...
function delete_sale(sale_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>admin/sales/anulation/" + sale_id;
        }
    })
}
</script>

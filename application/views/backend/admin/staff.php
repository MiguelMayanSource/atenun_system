...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                ...
                <!--<a class="add-buton pull-right" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_new_staff/1');">+ Agregar Personal</a>-->
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/staff_new/1';?>">+ Agregar Personal</a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <center><br>
                    <h4 style="text-align:center;color:#4d4a81;margin-top:2%;">Aún no se tiene personal registrado</h4>
                    <br>

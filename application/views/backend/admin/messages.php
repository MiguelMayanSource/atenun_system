...
<head>
            ...
            <div class="recent-default dynemic-sidebar active">
                <div class="recent">
                    <div class="theme-title">
                        <div class="media">
                            <div>
                                <a href="<?php echo base_url();?>admin/chat/" style="font-size:35px"><i class="picons-thin-icon-thin-0132_arrow_back_left"></i></a>
                ...
                <div class="chat custom-scroll">
                    <div class="theme-tab tab-sm chat-tabs" style="padding-top: 50px;">
                        ...
                        ?>
                                                <a href="<?php echo base_url();?>admin/messages/<?php echo $this->db->get_where($user_to_show_type, array($user_to_show_type . '_id' => $user_to_show_id))->row()->username;?>" style="text-decoration:none;">
                      ...
                      <?php 
                        ...
                        if($this->crud_model->check_online_status($type, $c['id']) > 0):?>online<?php else:?>busy<?php endif;?> bg-size" style="background-image: url(<?php echo $this->accounts_model->get_photo($type, $c['id']);?>); background-size: cover; background-position: center center; display: block;">
                                        ...
                                        <div class="contact-action">
                                            <div class="icon-btn btn-outline-primary btn-sm button-effect" onclick="javascript:location.href='<?php echo base_url();?>admin/messages/<?php echo $c['username']?>'"><i data-feather="message-square"></i></div>
    ...
    <div class="chitchat-main" id="content">
        <div class="chat-content tabto active">
                            ...
                            <ul class="calls text-right">
                                ...
                                <li class="chat-friend-toggle"><a class="icon-btn btn-light bg-transparent button-effect outside" href="#" data-tippy-content="Acciones del chat"><i data-feather="more-vertical"></i></a>
                                    <div class="chat-frind-content">
                                        <ul>
                                            <li>
                                                <a class="icon-btn btn-outline-primary button-effect btn-sm" href="#" onclick="javascript:location.href='<?php echo base_url();?>/admin/<?php echo $user_type == 'admin'? 'doctor':$user_type;?>_profile/<?php echo base64_encode($user_id);?>'"><i data-feather="user"></i></a>
                                                <h5 style="cursor:pointer" onclick="javascript:location.href='<?php echo base_url();?>/admin/<?php echo $user_type == 'admin'? 'doctor':$user_type;?>_profile/<?php echo base64_encode($user_id);?>'">Perfil</h5>
                                        ...
                                        <ul class="msg-box">
                                            ...
                                            <li class="msg-setting-main">
                                                <div class="document"><i class="fa fa-files-o font-primary"></i>
                                                    ...
                                                    <div class="icon-btns"><a class="icon-btn btn-outline-light" href="<?php echo base_url();?>admin/force_download_messages/<?php echo $row['file_name'];?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download">
            ...
            <?php echo form_open(base_url() . 'admin/chat/send_message', array('enctype' => 'multipart/form-data', 'id'=>'formMessage')); ?>
        ...
        <div class="custom-scroll right-sidebar">
            ...
            <div class="status other">
                ...
                <ul>
                    ...
                    <li>
                        <h5><a href="<?php echo base_url() . 'admin/'.$user_type.'_profile/'.base64_encode($user_id); ?>"> <i data-feather="crosshair"></i>Ir al perfil</a></h5>
                    </li>
                    <li>
                    ...
                    ?>
                            <ul class="document-list">
                                ...
                                <li><i class="ti-folder font-primary"></i>
                                    <h5><a href="<?php echo base_url();?>admin/force_download_messages/<?php echo $file['file_name'];?>"><?php echo $file['original_file_name'];?></a></h5>
                                </li>
                                <?php endif;?>
    ...
    var AjaxURL = '<?php echo base_url();?>' + '/admin/chat/send_message';
    ...
    $(document).ready(function() {
        ...
        $("#contact_search").keyup(function(e) {
            ...
            $(".contact-log-main").queue(function(n) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url();?>admin/get_contacts',
                    data: "b=" + consulta,
                    dataType: "html",

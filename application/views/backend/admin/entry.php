    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>admin/entry/">
...
<!-- <div class="row">
    <div class="col-sm-12">
        <div class="title-header">
            ...
            <?php echo form_open(base_url() . 'admin/entry_staff/', array('class' => 'form m-b'));?>
...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="filters" method="POST" action="<?php echo base_url();?>admin/entry">

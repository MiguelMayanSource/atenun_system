...
<div id="main-content">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title">Contadores registrados</h3>

                <!-- <a class="add-buton pull-right" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_new_staff/5');">+ Agregar contador</a>-->
                <a class="add-buton pull-right" href="<?php echo base_url().'admin/staff_new/5';?>">+ Agregar Personal</a>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <center><br>
                    <h4 style="text-align:center;color:#4d4a81;margin-top:2%;">Aún no se tiene Contadores registrados</h4>
                    <br>

<h5 class="panel-content-title">Ordenes de laboratorios <?php if($page_name != "patient_profile" ):?><a href="javascript:void(0)" onclick="load_view('new_labs','labs',{'patient_id':<?php echo $patient_id; ?>,'origin_id':'<?php echo $origin_id;?>','origin_type':'<?php echo $origin_type;?>'})" style="margin-bottom:10px" class="btn btn-info float-right mb-10">Nueva orden de laboratorio</a><?php endif; ?></h5>

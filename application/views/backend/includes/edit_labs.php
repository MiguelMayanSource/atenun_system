...
<h5 class="panel-content-title">Editar orden de laboratorio</h5>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-sm-12" style="margin-top:10px;">
            <a class="btn btn-danger" style="margin-left:10px;" href="javascript:void(0)" onclick="load_view('patient_labs','labs',{'patient_id':<?php echo $medic_order->patient_id;?>})">Terminar</a>
            <a class="btn btn-success float-right" style="margin-left:10px;" target="_blank" href="<?php echo base_url().$this->session->userdata('login_type');?>/appointment_details/lab_details/<?php echo $medic_order_id;?>">Imprimir orden</a>
        </div>
    </div>
</div>
<script>

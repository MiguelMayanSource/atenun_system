...
<div id="main-content">
    <div class="card-widget">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url();?>doctor/survey_results/<?php echo $codigo;?>">Resultados</a>
            </li>
        </ul>
        <br>
...
function update_table(patient_id) {
    ...
    $.ajax({
        url: '<?php echo base_url();?>doctor/get_reply/' + code + '/' + patient_id,

        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link " href="<?php echo base_url();?>doctor/whatsapp/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0317_send_post_paper_plane"></i></div> <span>Enviar Mensaje</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>doctor/whatsapp_notifications/">
    ...
    <div class="row">
        ...
        <div class="col-md-4 m-b-30">
            <div class="card-box">
                ...
                <div class="card-b">
                    <form action="<?php echo base_url();?>doctor/whatsapp_notifications/update/<?php echo $noti['type'];?>" method="POST" enctype="multipart/form-data" id="formWhatsapp">

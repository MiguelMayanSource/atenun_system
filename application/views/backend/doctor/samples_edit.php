    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <form action="<?php echo base_url().'doctor/samples/edit/'.$ID;?>" method="post" enctype="multipart/form-data" id='formAdd'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3'>
                            <div class="form-group" id="buscarPaciente">
                                ...
                                <input autocomplete="off" class="form-control" name='name' value="<?php echo $data_edit->patient_name;; ?>" required id='patient' onkeyUp="getPatients(this.value)" placeholder='Buscar paciente'>
                            </div>
                        ...
                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 '>
                            <div class="form-group">
                                ...
                                <select name="doctors_id" class='form-control basic' required id='doctor_id'>
                                    ...
                                    <?php $this->db->order_by('first_name','ASC'); $doctors = $this->db->get_where('admin', array('status !='=>0,'owner'=>0))->result_array(); foreach($doctors as $doc):?>
                                    <option value="<?php echo $doc['admin_id'];?>" <?php echo ($data_edit->doctors_id == $doc['doctor_id'] ) ? 'selected':''; ?>><?php echo $doc['first_name'].' '.$doc['last_name'];?></option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pago'>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="metodo" onchange="getMetodo(this.value)">
                                    <option value="1" <?php $method = 1 ?>>Efectivo</option>
...
function getPatients(name) {
    ...
    if (name.length > 0) {
        $.ajax({
            url: "<?php echo base_url().'doctor/getPatients/';?>",
            type: "POST",
            data: {
                name: name,
            },
...
function getDiagnostico(doctor_id) {
    ...
    $.ajax({
        url: "<?php echo base_url().'doctor/getDiagnostico';?>",
        type: "POST",
        dataType: "json",
        data: {
            doctor_id: doctor_id,
...
function getPrice(element, price_id) {
    ...
    $.ajax({
        url: "<?php echo base_url().'doctor/getPrice/';?>",
        type: "POST",
        data: {
...
function addPieza() {
    ...
    $.ajax({
        url: "<?php echo base_url().'doctor/getPieza';?>",
        type: "POST",
        data: {
...
function print(code) {
    ...
    $.ajax({
        url: "<?php echo base_url().'doctor/samples/get/';?>",
        type: 'post',
        data: {
            code: code
        },
...
function laboratoriesExamns(value, no) {
    ...
    $.ajax({
        url: '<?php echo base_url()?>doctor/getExamns',
        type: 'POST',
        data: {
            laboratories: value,
        },

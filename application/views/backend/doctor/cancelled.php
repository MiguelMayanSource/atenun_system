                        ...
                        <div class="tasks-list-w">
                            <ul class="tasks-list">
                                <?php
                                    ...
                                    if($filter)
                                    {
                                        $appointments =  $this->crud_model->appointment_canceled_doc($doctor_id,$apply,$clinic_id, $querys)->result_array();
                                    }else
                                    {
                                        $appointments =  $this->crud_model->appointment_canceled_doc($doctor_id,date('d/m/Y'),$clinic_id, $querys)->result_array();
                                    }

...
<div class="todo-app-w">
    ...
    <div class="todo-content" style="background-color: #f0f0f8;padding-bottom: 15%;">
        <h4 class="todo-content-header">
            <a href="<?php echo base_url();?>doctor/treatment/<?php echo base64_encode($patient_id);?>"><i class="batch-icon-arrow-left"></i></a> <span>Detalles del tratamiento - <?php echo $details['name'];?></span>
        </h4>
        ...
        <form action="<?php echo base_url();?>doctor/update_treatment" method="POST">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="col-sm-12 col-lg-12" id="resumen22">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-4">
                        <div class="form-group">
                            <a class="btn btn-danger full-width" href="<?php echo base_url().'doctor/update_treatment/close_treatment/'.$treatment_id.'/'.$patient_id;?>">Finalizar tratamiento</a>
                        </div>
                    </div>
                    <?php endif;?>
                    <?php if( $stat != 4):?>
                    <div class="col-sm-12 col-lg-4">
                        <div class="form-group">
                            <a class="btn btn-warning full-width" href="<?php echo base_url().'doctor/update_treatment/end_appointment/'.$treatment_id.'/'.$patient_id;?>">Finalizar cita</a>
                        </div>
                    </div>
                    <?php else:?>
                    <div class="col-sm-12 col-lg-4">
...
function update_table(appointment_id) {
    $.ajax({
        url: '<?php  echo base_url();?>doctor/update_prescription_table/' + appointment_id,
...
function set_status(element_id, element_id2) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/set_status_treatment/' + element_id + '/' + element_id2,
                success: function(response) {
                    location.reload();
                }
...
function delete_consult(element_id, element_id2) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/update_treatment/not_consult/' + element_id + '/' + element_id2,
                success: function(response) {
                    location.reload();
...
function add_consult(element_id, element_id2) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/update_treatment/add_consult/' + element_id + '/' + element_id2,
                success: function(response) {
                    location.reload();
...
function tooth_delete(element_id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/delete_tooth_treatment/' + element_id,
                success: function(response) {
                    location.reload();
                }
...
$(document).ready(function() {
    ...
    $("#submit_button").click(function() {
        ...
        if (appointment_id != '' && medicine != '' && quantity != '' && frequency != '' && duration != '') {
            $.ajax({
                url: "<?php echo base_url();?>doctor/prescriptions/create/",
                type: 'POST',
                data: {
                    medicine: medicine,
                    quantity: quantity,
...
function delete_element(element_id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/prescriptions/delete/' + element_id,
                success: function(response) {
                    update_table(<?php echo $appointment_id;?>);
                }
            });
...
function pay_delete(element_id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '<?php echo base_url();?>doctor/update_treatment/delete/' + element_id,
                success: function(response) {
                    location.reload();

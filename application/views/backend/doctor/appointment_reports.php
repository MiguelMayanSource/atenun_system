        ...
        <div class="os-tabs-w">
            <div class="os-tabs-controls">
                <ul class="navx nav-tabs">
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-link current" href="<?php echo base_url();?>doctor/appointment_reports/">
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-link" href="<?php echo base_url();?>doctor/inventory_reports/">
                            <div class="navWidget"><i class="picons-thin-icon-thin-0820_medicine_drugs_ill_pill"></i>
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-link" href="<?php echo base_url();?>doctor/reports/">
                            <div class="navWidget"><i class="picons-thin-icon-thin-0386_graph_line_chart_statistics"></i></div>
                            <span>Actividad</span>
                        </a>
                    </li>
                </ul>
    ...
    <div id="main-content">
        <div class="row">
            <div class="col-sm-12">
                <div class="card-widget">
                    <h4 class="panel-content-title">
                        <?php if($doctor_id != "") echo 'Cirugías de '.$this->accounts_model->gender($doctor_id).' '.$this->accounts_model->get_name('admin',$doctor_id);?> <?php
                    if($doctor_id != "" && $fecha1 != "" && $fecha2 != "")
                    { ?>
                        <span style="font: 17px 'Proxima Nova',Helvetica,Arial,sans-serif;   font-style: italic;  font-weight: 400;">[<?php echo $this->crud_model->formatear($fecha1)?>
                            - <?php echo $this->crud_model->formatear($fecha2)." del ".date('Y'); ?>]</span>
                        <?php }   
                    else{
                        $anioActual = date("Y");
                        $mesActual = date("m");
                        ...
                        $fecha2 = $fecha;
                    ?>
                        <?php echo $this->crud_model->formatear($fecha)?> -
                        <?php echo $this->crud_model->formatear($hoy)." del ".date('Y'); ?>
                        <?php    } ?>
                    </h4>
                    <span class="app-divider2"></span>
                    <form action="<?php echo base_url();?>doctor/appointment_reports/" method="POST">
                        <div class="row">
                            <div class="col-sm-4">
                                <label>Especialista</label>
                                <select class="itemName form-control select2" required="" style="width:100%; float:right" name="doctor_id">
                                    <option value="">Seleccionar</option>
                                    <?php $this->db->where('status','1');$this->db->where('clinic_id',$this->session->userdata('current_clinic'));$this->db->order_by('first_name', 'ASC');$query = $this->db->get('admin')->result_array();
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="card-widget">
                                    <h4 class="panel-content-title">Cirugías por sala</h4>
                                    <span class="app-divider2"></span>
                                    <!-- <svg id="doughnut-chart" viewBox="0 0 600 650" style="width:100%;"
                                        preserveAspectRatio="xMidYMid meet"></svg>
                                    <div class="doughnut-tooltip"></div> -->
                                    <canvas id="doughnut" height="290" style="width:100%"></canvas>
                                </div>
                            </div>

                            <div class="col-sm-8">
                                <div class="card-widget">
                                    <h4 class="panel-content-title">Cirugías de este mes</h4>
                                    <span class="app-divider2"></span>
        ...
        const chart = new Chart('myChart', {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Tus Cirugías',
                    data: [
                        <?php $this->crud_model->get_month_appoitments_report($doctor_id, $fecha1,$fecha2); ?>
                    ],
        ...
        var myChart = new Chart(ctx, {
            type: "doughnut",
            data: {
                labels: [<?php $this->crud_model->get_salas();?>],
                datasets: [{
                    data: [<?php $this->crud_model->get_salas_datos();?>],
                    backgroundColor: [<?php $this->crud_model->get_salas_color();?>],
                    hoverOffset: 4,
                }, ],
            },
        });

...
<div class="modal-content animated fadeInDown" style="border-radius:20px;">
    <?php 
            ...
            if (count($dats) == 0){
            ?>
    <form id="formPost" action="<?php echo base_url();?>doctor/patients/create_postnatal/<?php echo $param2;?>" method="post">
        <?php }
	         else {
            ?>
        <form id="formPost" action="<?php echo base_url();?>doctor/patients/update_postnatal/<?php echo $param2;?>" method="post">
            <?php } ?>

    ...
    <div class="modal" id="2new_category">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content animated fadeInDown">
                <form action="<?php echo base_url();?>doctor/solicitudes/create" method="POST">
...
$(document).ready(function() {
    ...
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/combos'; ?>",
            type: "POST"
        },
        "columnDefs": [{
            "targets": 0,
...
function deletePedido(category_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/solicitudes/delete/" + category_id;
        }
    })
}
...
function setPedidos(category_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/solicitudes/set/" + category_id;
        }
    })
}
    </script>
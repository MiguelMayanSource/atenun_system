    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                <h3 class="module-title"><?php echo $insurance_id == 0?'Todos los pacientes':'Pacientes del Seguro '.$this->db->get_where('insurance',array('insurance_id'=>$insurance_id))->row()->name;?></h3>
                <a class="add-buton pull-right" href="<?php echo base_url().'doctor/patients_add/0'?>">+ Agregar
                    Paciente</a>
            </div>
        </div>
        <div class="col-sm-12">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/patients/'.$insurance_id; ?>",
            type: "POST"
        },

   	                        ...
   	                        <tr>
   	                            <td>
   	                                <div class="user-with-avatar">
   	                                    <img alt="" src="<?php echo $this->accounts_model->get_photo('patient', $pt['patient_id']);?>"><span> <?php echo $this->accounts_model->get_full_name('patient', $pt['patient_id']);?> </span>
   	                                </div>
   	                            </td>
   	                            <td>
   	                            ...
   	                            <td class="row-actions">
   	                                <div class="dropdown">
   	                                    ...
   	                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   	                                        <a class="dropdown-item" href="<?php echo base_url(); ?>doctor/patient_profile/<?php echo base64_encode($pt['patient_id']); ?>">Perfil</a>

    	            ...
    	            <div class="ae-side-menu">
    	                ...
    	                <ul class="ae-main-menu">
    	                    ...
    	                    <li data-toggle="tooltip" data-placement="right" title="Ingresos">
    	                        <a href="<?php echo base_url();?>doctor/financial/">
    	                    ...
    	                    <li class="active" data-toggle="tooltip" data-placement="right" title="Egresos">
    	                        <a href="<?php echo base_url();?>doctor/expenses/">
    	                    ...
    	                    <li data-toggle="tooltip" data-placement="right" title="Categorías">
    	                        <a href="<?php echo base_url();?>doctor/expense_category/">
    	            ...
    	            <div id="main-content">
    	                ...
    	                <div class="row">
    	                    ...
    	                    <div class="main-table-card col-sm-12 m-b-30">
    	                        <form action="<?php echo base_url();?>doctor/expenses" method="POST" id="filter_form">
			        ...
			        ?>
    	                                            <tr style="font-family:'Poppins';font-size:14px;">
    	                                                ...
    	                                                <td>
    	                                                    ...
    	                                                    <a href="<?php echo base_url();?>doctor/expenses/reference/<?php echo $row['expense_id'];?>"><i class="picons-thin-icon-thin-0096_file_attachment" style="color:#0176fe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Comprobante"></i></a>
    	                                                    <?php endif;?>
    	                ...
    	                <div class="modal" id="1new_expense">
    	                    <div class="modal-dialog modal-dialog-centered modal-lg">
    	                        <div class="modal-content animated fadeInDown" style="border-radius:20px;">
    	                            <form action="<?php echo base_url();?>doctor/expenses/create" method="POST" enctype="multipart/form-data">
    	                ...
    	                function delete_expense(expense_id) {
    	                    Swal.fire({
    	                        ...
    	                        if (result.value) {
    	                            location.href = "<?php echo base_url();?>doctor/expenses/delete/" + expense_id;
    	                        }
    	                    })
    	                }
    	                </script>
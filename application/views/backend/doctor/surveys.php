                                ...
                                <tbody>
			                     ...
			                     ?>
                                    <tr style="font-family:'Poppins';font-size:14px;font-weight:bold;color:#4b4a55" class="">
                                        ...
                                        <td>
                                            <a style="text-decoration:none;" href="<?php echo base_url();?>doctor/question_board/<?php echo $row['survey_id'];?>"><i style="vertical-align:-3px;color:#a7aabb;font-size:18px;font-weight:bold;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i></a>
...
function delete_survey(survey_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/surveys/delete/" + survey_id;
        }
    })
}
    </script>
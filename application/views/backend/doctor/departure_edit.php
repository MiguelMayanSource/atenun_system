            ...
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>doctor/departure/edit" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="<?php echo base_url().'doctor/policy_departure/'.base64_encode($departure_id);?>" class="btn btn-secondary">Póliza(s)</a>
                                    </div>
...
<script type="text/javascript">
    ...
    $(".select2-provider-purchase").select2({
        ...
        ajax: {
            url: "<?php echo base_url();?>doctor/getProviderAjax/1",
            type: "POST",
            dataType: "json",
            delay: 250,
    ...
    function verifyPeriod() {
        ...
        if (date != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/verifyPeriod/",
                data: {
                    date: date,
                },
                dataType: "json",
    ...
    function verifyNomen(id, i) {
        ...
        if (id != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/nomenByIDJson",
                data: {
                    id: id
                },
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    if (data.purchase == 1) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url();?>doctor/inputsPurchase",
                            data: {
                                cont: purCont,
                                index: i,
                                name: data.name,
    ...
    function addFieldSelect() {
        if (addHdg == false) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/addFieldSelect/",
                data: {
                    cont: cont,
                },
                dataType: "json",
    ...
    function checkIVASelect(por, nom, i) {
        ...
        if (nom_id != '') {
            ...
            if (divIVA > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/addIVASelect/",
                    data: {
                        nomen: nom,
                        reg: desc,
                        index: i,
    ...
    function checkISRSelect(i, reg) {
        ...
        if (nom_id != '') {
            ...
            if (divISR <= 0) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/addISRSelect/",
                    data: {
                        idx: i,
                        cant: cant,
                        cont: cont,
    ...
    function checkRetenSelect(reg, i) {
        ...
        if (nom_id != '') {
            ...
            if (divReten <= 0) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/addRetenSelect/",
                    data: {
                        idx: i,
                        cant: cant,
                        cont: cont,
    ...
    function checkExeSelect(i) {
        ...
        if (nom_id != '') {
            ...
            if (divExe > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/addExenSelect/",
                    data: {
                        idx: i,
                        cant: cant,
                        cont: cont,
    ...
    function sumarTotales() {
        ...
        if (totalDebe == totalHaber) {
            ...
            equalDH = false;
            if (totalDebe > totalHaber) $("#total").val(totalDebe.toFixed(2));
            else $("#total").val(totalHaber.toFixed(2));
        }
    ...
    function dataProvider(id, i, c) {
        if (id != '' && id != 'N') {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/getProviderJson/",
                data: {
                    id: id,
                },
                dataType: "json",
    ...
    function searchNumDoc(i, id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>doctor/countOtherExistPurchase/",
            data: {
                id: id,
                number: number
            },
    ...
    function deleteDetail(i, id, inx) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/departure_edit/deactivate_detail/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function deletePurchase(i, id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/departure_edit/deactivate_purchase/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

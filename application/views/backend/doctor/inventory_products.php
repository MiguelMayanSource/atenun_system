        ...
        <div class="col-sm-12">
            <div class="title-header"><br>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_service_imp_import/<?php echo $inventory_id; ?>');">Importar implementos de servicios</a>
                    <a class="dropdown-item" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_service_import/<?php echo $inventory_id; ?>');">Importar servicios</a>
                    <a class="dropdown-item" href="javascript:void(0);" onclick="modal_lg('<?php echo base_url();?>modal/popup/modal_product_import/<?php echo $inventory_id; ?>');">Importar inventario</a>
                </div>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1" >
                    ...
                    <a class="dropdown-item" href="<?php echo base_url();?>doctor/categories" >+ Categorías</a>
                </div>
</div>
            </div>
        </div>
                            ...
                            <table class="table table-padded" id="user_data">
                                <thead>
                                    <tr>
                                        ...
                                        <th>PRECIO ATENUN</th>
                                        <th>PRECIO EMPRESAS</th>
                                        <th>PRECIO ASEGURADORAS</th>
                                        <th>EXISTENCIA</th>
                                        <th>ACCIONES</th>
                                    </tr>
                                </thead>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/inventory/'.$inventory_id; ?>",
            type: "POST"
        },
...
function delete_inventory(product_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/inventory_products/delete/" + product_id;
        }
    })
}
</script>
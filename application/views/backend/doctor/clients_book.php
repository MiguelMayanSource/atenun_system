...
<div id="main-content">
    <div class="row">
            ...
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <form method="post" action="<?php echo base_url();?>doctor/clients_book/">
                                <div class="row">
        ...
        <form method="POST" action="<?php echo base_url();?>doctor/printFormType/clients_book/" id="frmC" target="_blank">
...
<script type="text/javascript">
    ...
    $("#client_id").select2({
        ...
        <?php endif;?>
        ajax: {
            url: "<?php echo base_url();?>doctor/getClientSearchAjax/",
            type: "POST",
            dataType: "json",
            delay: 250,
    ...
    function setArrayValues() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>doctor/setChecksClients/",
            data: {
                vals: vals,
            },
            dataType: "json",

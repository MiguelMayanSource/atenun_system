            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>doctor/departure/create/" method="POST" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function searchNumDoc(i) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>doctor/countExistPurchase/",
            data: {
                number: number
            },
            dataType: "json",

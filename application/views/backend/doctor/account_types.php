                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="btn-toolbar mb-2">
                                <div class="">
                                    <a class="btn btn-primary" href="<?php echo base_url();?>doctor/bank_accounts/">
    ...
    function desactivarTipo(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/account_types/deactivate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function activarTipo(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/account_types/activate/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function eliminarTipo(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/account_types/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

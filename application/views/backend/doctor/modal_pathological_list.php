...
input[type=radio]:checked:after {
	...
	<div class="modal-content animated fadeInDown" style="border-radius:20px;">
        ...
        if (count($dats) == 0){
        ?>
	    <form id="formPatholgical" action="<?php echo base_url();?>doctor/patients/create_pathological/<?php echo $param2;?>" method="post">
	        <?php }
        
        else {
        ?>
	        <form id="formPatholgical" action="<?php echo base_url();?>doctor/patients/update_pathological/<?php echo $param2;?>" method="post">
	            <?php } ?>

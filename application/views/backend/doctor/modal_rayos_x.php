    <?php
        $this->db->where('rayos_x_id', $param2);
        $laboratories = $this->db->get('rayos_x')->result_array();
        foreach($laboratories as $row):
    ?>
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/rayos_x/update/<?php echo $row['rayos_x_id'];?>" method="POST">

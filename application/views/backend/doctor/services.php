    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>doctor/supplies/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0172_structure_menu_submenu_navigation"></i></div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header"><br>
                ...
                <a class="add-buton pull-right" href="javascript:void(0);" data-toggle="modal" data-target="#1new_product">+ Nuevo Servicio</a>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card-b">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/services'; ?>",
            type: "POST"
        },
...
<div class="modal" id="1new_product">
    <div class="modal-dialog modal-dialog-centered modal-big">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/services/create" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group m-b-15">
                                        ...
                                        <input type="text" step="any" name="name" required="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group m-b-15">
                                        <label for="simpleinput">Costo</label>
                                        <input type="number" step="any" name="cost" required="" class="form-control" min='0'>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group m-b-15">
                                        <label for="simpleinput">Precio</label>
                                        <input type="number" step="any" name="price" required="" class="form-control" min='0'>
                                    </div>
                                </div>
                            </div>
                        </div>
...
function delete_inventory(product_id) {
    Swal.fire({
        title: '¿Estás seguro?',
        text: "También se eliminará toda la información relacionada a este servicio",
        type: 'info',
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>doctor/services/delete/" + product_id;
        }
    })
}
</script>
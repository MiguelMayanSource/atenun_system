...
<div id="main-content">
    ...
    <div class="col-xl-12  col-lg-12 col-sm-12  layout-spacing card-widget">
        <div class="widget-content widget-content-area br-6">
            ...
            <div class="">
                <form action="<?php echo base_url();?>doctor/laboratory_results/save" method='POST'>
                    ...
                    <?php    
                 $cont1 = 0;
                $laboratories = $this->db->get_where('sample_piece',array('sample_id'=>base64_decode($ID)))->result_array(); 
                            foreach($laboratories as $laboratory):
                            ?>
                    <br>
                    <h3><?php echo $this->db->get_where("product",array("product_id"=>$laboratory['laboratory_id']))->row()->name;  ?></h3>
                        ...
                        <table class="table table-bordered mb-10">
                            ...
                            <tbody class="row_position">
                              ...
                              if($laboratory['results']== ""):
                                    $fields = json_decode($laboratory['exams'],true);
                                    $cont = 1;
                                    foreach($fields as $field_detail):
                                    $field =  $this->db->query("SELECT * FROM `laboratory_fields` WHERE laboratory_fields_id = ".$field_detail)->row_array();
                              ?>

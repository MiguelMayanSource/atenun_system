...
<div class="modal-content animated fadeInDown">
    <form action="<?php echo base_url();?>doctor/bank_transfers/new/" method="POST">
...
<script type="text/javascript">
    ...
    function otherAccounts() {
        ...
        if (id != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/getOtherBankAccounts/",
                data: {
                    id: id,
                    property: property,
                },
    ...
    function checkBalance() {
        ...
        if (id != '' && amount != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>doctor/checkBalanceBankAccount/",
                data: {
                    id: id,
                    amount: amount,
                },

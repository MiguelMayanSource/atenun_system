...
<div id="main-content">
    ...
    <form action="<?php echo base_url();?>doctor/sales/create_sale_insurance" method="POST" id="sales_form" onsubmit="return validateForm()">
                ...
                <div class="order-box">
                    <div class="order-details-box">
                        <div class="order-main-info">
                            <strong style="font-size:28px;">Formulario de ventas</strong>
                        </div>
                    </div>
                    <hr>
                            ...
                            <div class="order-controls">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-ms-12 mb-2">
                                        <div class="" id="divNIT">
                                            <input type="text" class="form-control" name="nit" id="nit"  placeholder="NIT" onblur="verifyClient()" />
                                            <div class="col-form-label">NIT: <small class="text-danger msgClient"></small></div>
                                        </div>
                                        <div class="" id="divCUI" style="display:none;">
                                            ...
                                            <div class="col-form-label">CUI: <small class="text-danger msgClient"></small> </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-ms-12" >
                                        <h5 class="font-size-14 mt-2">Datos para la aseguradora: </h5>
                                    </div>
                                    <div class="col-lg-6 mb-2" >
                                        <div class="">
                                            
                                            <select name="insurance_id" id="insurance_id" class="form-control select2-cash" required >
                                                <option value="">Seleccione un seguro</option>
                                                <?php 
                                                $insurance = $this->db->get_where('insurance',array('status'=>'1'));
                                                foreach($insurance->result_array() AS $ch): ?>

                                                <option value="<?php echo $ch['insurance_id'];?>"><?php echo $ch['name'].' '.$ch['code'];?></option>
                                                <?php  endforeach;?>
                                            </select>
                                            <label for="insurance_id" class="col-form-label">Aseguradora<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group m-b-15">
                                            <input style="border: 1px solid #198cff8f;" type="tel" name="titular" class="form-control" required>
                                            <label for="simpleinput">Titular<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group m-b-15">
                                            <input style="border: 1px solid #198cff8f;" type="tel" name="dpi_titular" class="form-control" required>
                                            <label for="simpleinput">DPI Titular<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 mb-2" >
                                        <div class="">
                                            <input type="text" class="form-control" name="authorization" required></input>
                                            <label for="cash_id" class="col-form-label">No. de Autorización<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 mb-2" >
                                        <div class="">
                                            <input type="text" class="form-control" name="move_economy" required></input>
                                            <label for="cash_id" class="col-form-label">Movimiento económico<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 mb-2" >
                                        <div class="">
                                            <input type="text" class="form-control" name="record" required></input>
                                            <label for="cash_id" class="col-form-label">Expediente<span class="text-danger">*</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function getProducts(product_id, variant_id) {
    $.ajax({
        url: '<?php echo base_url();?>doctor/get_products/' + product_id,
        success: function(response) {
...
function getPrice(product_id, variant_id) {
    ...
    var price = 1;
    $.ajax({
        url: '<?php echo base_url();?>doctor/get_product_price/' + product_id + '/' + price,
        success: function(response) {
            console.log(response);

                            ...
                            <div class="patient-info">
                                <div class="profile-tile-box">
                                    ...
                                    <div class="pt-user-last">
                                        <a href="<?php echo base_url(); ?>doctor/patient_profile/<?php echo base64_encode($det['patient_id']); ?>" style="color:black;text-decoration:none;"><?php echo $this->accounts_model->get_name('patient',$det['patient_id']);?></a>.
                                    </div>
                                    <br>

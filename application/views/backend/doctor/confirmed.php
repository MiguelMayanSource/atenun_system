                        ...
                        <div class="order-box">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <?php if($row['status'] == 0):?>
                                    <a class="btn btn-danger" onclick="return confirm('¿Estás seguro que deseas cancelar la factura? Tu suscripción no se completará y deberás crear una nueva.');" style="color:#fff;" href="<?php echo base_url();?>doctor/subscription/cancel/<?php echo $row['code'];?>">Cancelar esta factura <i class="picons-thin-icon-thin-0153_delete_exit_remove_close"></i> </a><br><br>
                                    <?php else:?>
                                    <a class="btn btn-primary" style="color:#fff;" href="<?php echo base_url();?>doctor/panel/">Regresar a tu tablero <i class="picons-thin-icon-thin-0160_arrow_next_right"></i> </a><br><br>
                                    <?php endif;?>
                                </div>
                            </div>
                        </div>

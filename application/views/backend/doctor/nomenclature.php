    ...
    <div class="row">
        <div class="col-md-12">
            <div class="title-header">
                ...
                <a class="add-buton" href="<?php echo base_url();?>doctor/departures/">Pártidas</a>
            </div>
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
    ...
    function desactivarNomen(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/nomenclature/deactivate_nomen/"+id,
                    beforeSend: function () {
                        Swal.fire({
                            title: "Cargando",
    ...
    function activarNomen(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/nomenclature/activate_nomen/"+id,
                    beforeSend: function () {
                        Swal.fire({
                            title: "Cargando",
    ...
    function eliminarNomen(id,nombre) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>doctor/nomenclature/delete_nomen/"+id,
                    beforeSend: function () {
                        Swal.fire({
                            title: "Cargando",

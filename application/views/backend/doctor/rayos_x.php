    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>doctor/rayos_x/">
                        <div class="navWidget"><i class="picons-thin-icon-thin-0827_body_weight_fitness_health_fat"></i></div><span>Rayos X</span>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a class="nav-link" href="<?php echo base_url();?>doctor/product_estb/">
...
<div class="modal" id="123myModal">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>doctor/rayos_x/create" method="POST">
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'doctor/getTable/rayos_x'; ?>",
            type: "POST"
        },

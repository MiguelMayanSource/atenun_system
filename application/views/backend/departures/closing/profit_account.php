<?php $grupos = $this->crud_model->getGroupsAccount(); 
    ...
    $debit = 0; $credit = 0; $total = 0; $neta = abs($val['net']);?>
...
<div class="row">
            ...
            <table class="table table-bordered mb-0">
                ...
                <tbody id="rowInputs">
                    ...
                    <tr class="" id="rowField_2">
                        <?php $code = '';
                            if ($val['net'] >= 0) $code = "3.02.01.002";
                            else $code = "3.02.02.002";
                            $nom = $this->crud_model->getNomenByCode($code);
                            $nom_id = $nom['nomenclature_id'];
                            $total = $neta;
                            $credit += $total;?>
                        <td id="selectNomen_2">
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Contabilización de la <?php if($total >= 0) echo "ganancia"; else echo "perdida";?></textarea>
    </div>

...
<div class="row">
                ...
                <tbody id="rowInputs">
                    ...
                    <tr class="" id="rowField_2">
                        <?php $nom = $this->crud_model->getNomenByCode("5.01.01.006");
                            $nom_id = $nom['nomenclature_id'];
                            $total = $this->crud_model->getTotalYearNom($nom_id, $initial, $final, 4);
                            $debit += $total;?>
                        <td id="selectNomen_2">
                            <div class="input-group">
                                <div style="width:80%">
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control debe" id="debe_2" name="debe[]" value="<?php echo $total;?>" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control haber" id="haber_2" name="haber[]" value="" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div style="display:flex;">
                    ...
                    <tr class="" id="rowField_3">
                        <?php $group = $this->crud_model->getGroupByCode("5.01.01");
                            $total = $this->crud_model->getTotalYearCloseFinalInventory($initial, $final);
                            $credit += $total;?>
                        <td id="selectNomen_3">
                            <div class="input-group">
                                <div style="width:80%">
                                ...
                                <input type="hidden" name="type_nom[]" id="type_nom_3" value="group_account" />
                            </div>
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Registro del inventario final de mercaderías y si hay devoluciones se agrega liquidación de las cuentas saldo acreedor</textarea>
    </div>

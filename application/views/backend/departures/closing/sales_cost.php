<?php $grupos = $this->crud_model->getGroupsAccount(); $debit = 0; $credit = 0; $total = 0;?>
...
<div class="row">
                ...
                <tbody id="rowInputs">
                    <tr class="" id="rowField_1">
                        <?php $group = $this->crud_model->getGroupByCode("5.01.01");
                            $total = $this->crud_model->getTotalYearCloseSale($initial, $final);
                            $debit += $total;?>
                        <td id="selectNomen_1">
                            <div class="input-group">
                                <div style="width:80%">
                                    <select class="form-control select2-nom" id="nomen_id_1" name="nomen_id[]" onchange="verifyNomen(this.value, 1)">
                                        ...
                                        <?php foreach($grupos->result_array() as $gp):?>
                                            <?php if($gp['hide'] != 1):?>
                                        <option value="<?php echo $gp['group_account_id'];?>" <?php if($gp['group_account_id'] == $group['group_account_id']) echo "selected";?>><?php echo $gp['code'].' '.$gp['name'];?></option>
                                ...
                                <input type="hidden" name="type_nom[]" id="type_nom_1" value="group_account" />
                            </div>
                    ...
                    <tr class="" id="rowField_2">
                        <?php $nom = $this->crud_model->getNomenByCode("5.01.01.001");
                            ...
                            $total = $this->crud_model->getInitialInventory($initial);
                            $credit += $total;?>
                        <td id="selectNomen_2">
                            <div class="input-group">
                                <div style="width:80%">
                    ...
                    <tr class="" id="rowField_3">
                        <?php $nom = $this->crud_model->getNomenByCode("5.01.01.003");
                            $nom_id = $nom['nomenclature_id'];
                            $total = $this->crud_model->getTotalYearNom($nom_id, $initial, $final, 5);
                            $credit += $total;?>
                        <td id="selectNomen_3">
                            <div class="input-group">
                                <div style="width:80%">
                                    <select class="form-control select2-nom" id="nomen_id_3" name="nomen_id[]" onchange="verifyNomen(this.value, 1)">
                                        <option value="">Seleccionar</option>
                                        <?php foreach($grupos->result_array() as $gp):?>
                                            <?php if($gp['hide'] != 1):?>
                                        <option value="<?php echo $gp['group_account_id'];?>"><?php echo $gp['code'].' '.$gp['name'];?></option>
                                ...
                                <input type="hidden" name="type_nom[]" id="type_nom_3" value="nomenclature" />
                            </div>
                            <small class="text-danger" id="msgNomen_3"></small>
                        </td>
                        <td>
                            <div class="input-group">
                                <span class="input-group-addon input-group-prepend">
                                ...
                                <input type="number" class="form-control debe" id="debe_3" name="debe[]" value="" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control haber" id="haber_3" name="haber[]" value="<?php echo $total;?>" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div style="display:flex;">
                                <button class="btn btn-danger" type="button" onclick="deleteParent(3)">x</button>
                            </div>
                        </td>
                    </tr>
                    <tr class="" id="rowField_4">
                        ...
                        <td id="selectNomen_4">
                            <div class="input-group">
                                <div style="width:80%">
                                    <select class="form-control select2-nom" id="nomen_id_4" name="nomen_id[]" onchange="verifyNomen(this.value, 1)">
                                        <option value="">Seleccionar</option>
                                        <?php foreach($grupos->result_array() as $gp):?>
                                            <?php if($gp['hide'] != 1):?>
                                        <option value="<?php echo $gp['group_account_id'];?>"><?php echo $gp['code'].' '.$gp['name'];?></option>
                                ...
                                <input type="hidden" name="type_nom[]" id="type_nom_4" value="nomenclature" />
                            </div>
                            <small class="text-danger" id="msgNomen_4"></small>
                        </td>
                        <td>
                            <div class="input-group">
                                <span class="input-group-addon input-group-prepend">
                                ...
                                <input type="number" class="form-control debe" id="debe_4" name="debe[]" value="" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control haber" id="haber_4" name="haber[]" value="<?php echo $total;?>" step="0.01" min="0" oninput="sumarTotales()" />
                            </div>
                        </td>
                        <td>
                            <div style="display:flex;">
                                <button class="btn btn-danger" type="button" onclick="deleteParent(4)">x</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Liquidación de las cuentas de costo de ventas</textarea>
    </div>

<?php $grupos = $this->crud_model->getGroupsAccount(); $debit = 0; $credit = 0; $total = 0; $gross = 0;?>
...
<div class="row">
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Liquidación de las cuentas de saldo acreedor</textarea>
    </div>

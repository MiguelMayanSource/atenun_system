...
<div class="row">
            ...
            <table class="table table-bordered mb-0">
                ...
                <tbody id="rowInputs">
                    <tr class="" id="rowField_1">
                        <?php $nom = $this->crud_model->getNomenByCode("5.03.01.011");
                    ...
                    <tr class="" id="rowField_2">
                        <?php $nom = $this->crud_model->getNomenByCode("1.02.01.002");
                            $nom_id = $nom['nomenclature_id'];?>
                        <td id="selectNomen_2">
                            <div class="input-group">
                                <div style="width:80%">
    ...
    <div class="col-lg-12 mt-3">
        ...
        <textarea rows="3" cols="" class="form-control" name="details" required>Razón por contabilizar las deprecaciones correspondientes de mobiliario y equipo</textarea>
    </div>

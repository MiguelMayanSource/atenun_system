...
input[type=radio]:checked:after {
	...
	<div class="modal-content animated fadeInDown" style="border-radius:20px;">
	    <?php 
                ...
                if (count($dats) == 0){
                ?>
	    <form id="formDiet" action="<?php echo base_url();?>staff/patients/create_nutriological/<?php echo $param2;?>" method="post">
	        <?php }
                
                else {
                ?>
	        <form id="formDiet" action="<?php echo base_url();?>staff/patients/update_nutriological/<?php echo $param2;?>" method="post">
	            <?php } ?>

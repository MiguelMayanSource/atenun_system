<ul class="tasks-list">
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="appointments"){ echo 'checked'; } ?> name="type" type="radio" class="custom-control-input" id="today" onclick="window.location.href='<?php echo base_url();?>staff/appointments/';">
    ...
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="cancelled"){ echo 'checked'; } ?> name="type" type="radio" class="custom-control-input" id="customCheck5" onclick="window.location.href='<?php echo base_url();?>staff/cancelled/';">
    ...
    <li>
        <div class="custom-control custom-radio">
            <input <?php if ($page_name=="archived"){ echo 'checked'; } ?> name="type" type="radio" class="custom-control-input" id="customCheck6" onclick="window.location.href='<?php echo base_url();?>staff/archived/';">

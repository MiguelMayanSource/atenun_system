        ...
        <div id="sticky_left">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters" method="POST" action="<?php echo base_url();?>staff/archived">
                                ...
                                <div class="alert alert-<?php echo $className;?>">
                                    ...
                                    <div class="pi-controls">
                                        ...
                                        if($appointment['status'] == 0)
                                        {
                                            ...
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>staff/pay_appointment/<?php echo base64_encode($appointment['appointment_id']); ?>">Recibo</a>

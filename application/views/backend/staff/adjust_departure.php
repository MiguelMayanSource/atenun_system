            ...
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3" style="float: right;">
                                <div class="btn-group focus-btn-group">
                                    <a class="btn btn-info" href="<?php echo base_url();?>staff/adjust/">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>staff/adjust_departure/create/" method="POST" enctype="multipart/form-data" id="frmC">
                                <div class="row">
                                            ...
                                            <div class="col-lg-5 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="category" id="category" required onchange="verifyPeriod()">
                                                        ...
                                                        <option value="furnit_equip">Dep. Mobiliario y equipo</option>
                                                        <option value="computer_equip">Dep. Equipo de Computación</option>
                                                        <option value="machinery">Dep. Maquinaria</option>
                                                        <option value="buildings">Dep. Edificios</option>
                                                        <option value="bank_loans">Prestamos bancarios</option>
...
<script type="text/javascript">
    ...
    function verifyPeriod() {
        ...
        if (category != '' && $.isNumeric(period) && period.length == 4 && ((type == 'month' && month != '') || type == 'year')) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>staff/verifyPeriodAdjust/",
                data: {
                    category: category,
                    type: type,
                    period: period,
    ...
    function chargeDeparture() {
        ...
        if (category != '' && $.isNumeric(period) && period.length == 4) {
            if (!ldD) {
                $.ajax({
                    method: "POST",
                    url: "<?php echo base_url();?>staff/chargeAdjustDeparture/",
                    data: {
                        category: category,
                        type: type,
                        year: period,
    ...
    function verifyForm() {
        var mensaje = '';
        if (valForm && chD && valMonth) $("#frmC").attr("action", "<?php echo base_url();?>staff/adjust_departure/create/");

        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/whatsapp/">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                <div class="card-b">
                    <form action="<?php echo base_url();?>staff/whatsapp/send" method="POST" enctype="multipart/form-data" id="formWhatsapp">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="middles">
                                    <label>

...
<div id="main-content">
    ...
    <form action="<?php echo base_url();?>staff/sales/create_cot" method="POST">
        <div class="row">
            <div class="col-md-12">
                <div class="order-box">
                    <div class="order-details-box">
                        <div class="order-main-info">
                            <strong style="font-size:38px;">Formulario de cotizaciones</strong>
                        </div>
                    </div>
                    <hr>
                    <div class="order-items-table">
                        ...
                        <div class="social-l col-lg-12 col m-b-30">
                            <div class="order-controls row" >
                                    ...
                                    <div class="col-lg-4 col-md-4 col-ms-12 mb-2">
                                        <h5 class="font-size-14 mt-2">Buscar por: <span class="text-danger">*</span></h5>
                        ...
                        <div class="order-foot">
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <button class="btn btn-success" type="submit">Confirmar cotización</button>
                                </div>

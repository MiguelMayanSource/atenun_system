...
<div class="todo-app-w">
    <div class="todo-content" style="margin-bottom: 8%;">
        <form action="<?php echo base_url();?>staff/doctors/new" method="POST" enctype="multipart/form-data" id="doc_form">
        <div class="row">
    ...
    $("#doc_form").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                window.location.href='<?php echo base_url(); ?>staff/doctors';
            },

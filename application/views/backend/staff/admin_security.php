    ...
    <div class="todo-sidebar">
        <div class="todo-sidebar-section" style="border-bottom:0px">
            ...
            <div class="todo-sidebar-section-contents">
                <ul class="tasks-list">
                    <li class="side-li">
                        <a class="side-items" href="<?php echo base_url();?>staff/admin_profile/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;    font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> Editar perfil </a>
                    </li>
                    <li class="side-li">
                    ...
                    <li class="side-li">
                        <a class="side-items active" href="<?php echo base_url();?>staff/admin_security/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0705_user_profile_security_password_permissions"></i> Contraseña y seguridad <span class="side-active"></span></a>
                    </li>
                    <li class="side-li">
                        <a class="side-items" href="<?php echo base_url();?>staff/admin_activity/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0244_text_bullets_list"></i> Registro de Actividad </a>
                    </li>
                </ul>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>staff/admins/update_password_profile/<?php echo $admin_id;?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-6">
            ...
            <div class="col-sm-4">
                ...
                <a onclick="remove_session(<?php echo $admin_id;?>);">
                ...
                <br>
                <?php if($owner == 1):?>
                <?php if($this->security_model->authStatusProfile($admin_id) != ''): ?>
...
function remove_auth() {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/admins/remove_auth_staff/<?php echo $admin_id;?>";
        }
    })
}
...
function remove_session($doct_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/admins/remove_sessions_doc/" + $doct_id;
        }
    })
}
</script>
...
function changePass() {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?php echo base_url();?>staff/password_change",
                type: 'POST',
                data: {

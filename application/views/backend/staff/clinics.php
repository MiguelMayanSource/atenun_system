        ...
        <div class="os-tabs-w">
            <div class="os-tabs-controls">
                <ul class="navx nav-tabs">
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-link current" href="<?php echo base_url();?>staff/clinics/">
    ...
    <div class="modal" id="123">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content animated fadeInDown">
                <form action="<?php echo base_url();?>staff/clinics/create" method="POST">
...
function delete_clinic(clinic_id) {
    Swal.fire({
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/clinics/delete/" + clinic_id;
        }
    })
}
    </script>
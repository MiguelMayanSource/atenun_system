            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <a class="btn btn-info text-white btn-lg" href="<?php echo base_url();?>staff/download_example/products" style="width:100%;"><i class="picons-thin-icon-thin-0123_download_cloud_file_sync"></i> Descargar formato</a>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">

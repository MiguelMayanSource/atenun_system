<?php
    ...
    $doctor_id = $this->session->userdata('doctor_id') != "" ?$this->session->userdata('doctor_id'):$this->session->userdata('login_user_id');
?>
                        ...
                        <div class="tasks-list-w">
                            <ul class="tasks-list">
                                <?php
                                    ...
                                    if($filter)
                                    {
                                        $appointments =  $this->crud_model->appointment_canceled_doc($doctor_id,$apply,$clinic_id, $querys.":00")->result_array();
                                    }else
                                    {
                                        $appointments =  $this->crud_model->appointment_canceled_doc($doctor_id,date('d/m/Y'),$clinic_id, $querys.":00")->result_array();
                                    }

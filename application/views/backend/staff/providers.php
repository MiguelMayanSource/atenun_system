    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="title-header">
                ...
                <a class="add-buton pull-right" href="<?php echo base_url().'staff/provider_new/';?>">+ Agregar proveedor</a>
            </div>
        </div>
                    ...
                    <div class="tile-controls">
                        <div class="tile-settings os-dropdown-trigger">
                            ...
                            <div class="os-dropdown">
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url();?>staff/provider_profile/<?php echo base64_encode($row['staff_id']);?>/"><i class="picons-thin-icon-thin-0699_user_profile_avatar_man_male"></i><span>Perfil</span></a>
                                    </li>

        ...
        <div id="sticky_left">
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form method="POST" action="<?php echo base_url();?>staff/pending_payment">
            ...
            <div class="todo-sidebar-section">
                ...
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li>
                            <form id="filters" method="POST" action="<?php echo base_url();?>staff/pending_payment">
                                ...
                                <div class="alert alert-<?php echo $className;?>">
                                    ...
                                    <div class="pi-controls">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="<?php echo base_url();?>staff/pay_appointment/<?php echo base64_encode($appointment['appointment_id']);?>">Cobrar</a>

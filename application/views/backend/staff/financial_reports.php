        ...
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/financial_reports/">
...
<div id="main-content">
    <div class="row">
        <div class="col-sm-12">
            <form action="<?php echo base_url();?>staff/financial_reports/" method="POST">
        ...
        <div class="col-sm-12">
            <div class="card-widget">
                ...
                <a target="_blank" class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/print_financial_report/<?php echo base64_encode($fecha1);?>/<?php echo base64_encode($fecha2);?>">IMPRIMIR</a>
                <a class="add-buton pull-right" style="margin-right:1px;" href="<?php echo base_url();?>staff/excel/<?php echo base64_encode($fecha1);?>/<?php echo base64_encode($fecha2);?>">EXCEL</a>
                <span class="app-divider2"></span>
...
$(document).ready(function() {
    var dataTable = $('#user_data').DataTable({
        ...
        "order": [],
        "ajax": {
            url: "<?php echo base_url() . 'staff/getTable/financial_reports/'.base64_encode($fecha1).'/'.base64_encode($fecha2); ?>",
            type: "POST"
        },

<?php 
    $doctor_id = $id_;  
    $documents = $this->db->get_where('document', array('user_id'=>$doctor_id, 'user_type'=>'admin', 'status'=>1));
        ...
        <div id="sticky">
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/doctor_profile/<?php echo base64_encode($details['admin_id']);?>/"><i style="padding-right: 10px;    font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> <?php if($owner == 1):?> Editar perfil <?php else:?> Ver
                        ...
                        <li class="side-li">
                            <a class="side-items" style="    color: red  !important;" href="javascript:void(0)" onclick="delete_doctor('<?php echo $details['admin_id'];?>');" ><i style="padding-right: 10px;font-size: 22px;" class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i> Eliminar doctor</a>
                        </li>
                    </ul>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>staff/doctors/edit/<?php echo $details['admin_id'];?>" method="POST" id="doctorUpdate" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group date-time-picker m-b-15">
                                                ...
                                                <input style="border: 1px solid #198cff8f;" type="date" id="applyDate" name="date_of_birth" autocomplete="off" value="<?php echo $details['date_of_birth'];?>" class="form-control" <?php if($owner != 1):?> readonly="" <?php endif;?>>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group m-b-15">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group date-time-picker m-b-15">
                                                <label for="simpleinvput">Fecha de vencimiento DPI <span style="color:red">*</span></label>
                                                <div class="input-group">
                                                    <input type="date" name="dpi_expire" autocomplete="off" style="border: 1px solid #198cff8f;" value="<?php echo $details['dpi_expire'];?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                         ...
                                         <div class="col-sm-4">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Especialidad principal <span style="color:red">*</span></label>
                                                <select class="itemName form-control select2" style="border: 1px solid #198cff8f;" required="" style="width:100%" name="specialty_1">
            								    	...
            								    	?>
                                                    <option value="<?php echo $cat['specialtie_id'];?>" <?php if( $cat['specialtie_id'] == $details['specialty_1'] ) echo 'selected'; ?> ><?php echo $cat['name'];?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
                                         <div class="col-sm-4">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Especialidad extras <span style="color:red">*</span></label>
                                                <select class="itemName form-control select2" style="border: 1px solid #198cff8f;" required="" style="width:100%" name="specialty_2[]" multiple>
                                                    <option value="">Seleccionar</option>
                                                    <?php 
            								        	$specialties = $this->db->get('specialtie')->result_array();
            								        	foreach($specialties as $cat):
            								    	?>
                                                    <option value="<?php echo $cat['specialtie_id'];?>" <?php if( in_array(  $cat['specialtie_id'], unserialize($details['specialty_2']) )) echo 'selected'; ?>><?php echo $cat['name'];?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group m-b-15">
                                                ...
                                                <select class="itemName form-control select2" style="border: 1px solid #198cff8f;" required="" style="width:100%" name="insurances[]" multiple>
                                                    ...
                                                    <?php 
            								        	...
            								        	foreach($specialties as $cat):
            								    	?>
                                                    <option value="<?php echo $cat['insurance_id'];?>" <?php if( in_array(  $cat['insurance_id'], unserialize($details['insurances']) )) echo 'selected'; ?>><?php echo $cat['name'];?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc; margin-top:20px;">
                                    <div class="row">
                                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="tasks-section" style="background: #fff; padding: 24px; border-radius: 25px; border: 1px solid #ccc; margin-top:20px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Titulo acádemico</label>
                                                <input style="border: 1px solid #198cff8f;" type="text" name="academic_title" class="form-control" value="<?php echo $details['academic_title'];?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Lugar de estudios</label>
                                                <input style="border: 1px solid #198cff8f;" type="text" name="place_study" class="form-control" value="<?php echo $details['place_study'];?>" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <label for="simpleinput">Número de colegiado<span style="color:red">*</span></label>
                                            <input type="text" name="no_college" class="form-control" value="<?php echo $details['no_college'];?>" />
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Fecha del título</label>
                                                <div class="input-group date datepicker" id="DoctorPicker3">
                                                    <input type="text" id="applyDate" name="date_title" autocomplete="off" style="border: 1px solid #198cff8f;" value="<?php echo $details['address'];?>" class="form-control">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Fecha de última confrontación</label>
                                                <div class="input-group date datepicker" id="DoctorPicker4">
                                                    <input type="text" id="applyDate" name="date_last_confront" autocomplete="off" style="border: 1px solid #198cff8f;" value="<?php echo $details['date_last_confront'];?>" class="form-control">
                                                    <span style="display: none;" class="input-group-addon"><i data-feather="calendar"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group m-b-15">
                                                ...
                                                <textarea type="text" style="border: 1px solid #198cff8f;" rows="3" name="comments" class="form-control"><?php echo $details['comments'];?></textarea>
                                            </div>
                                        </div>
                                        <!--<div class="col-sm-6">
                                            <div class="form-group m-b-15">
                                                <label for="simpleinput">Constancia de colegiado</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 mb-4">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <label for="simpleinput">Constancia de colegiado:</label>
                                                    <input type="file" name="doc_college" accept="image/*, application/pdf" />
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="simpleinput">Vencimiento:</label>
                                                    <input type="date" class="form-control" name="expiration_college" value="<?php echo date("Y-m-d");?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mb-4">
...
<script>
    $(document).ready(function() {
        fileSig = $('input[name="signature"]').fileuploader({
        ...
        fileColCert = $('input[name="doc_college"]').fileuploader({
            // Options will go here
            maxSize: 50,
            enableApi: true,
            captions: {
...
<script>
    ...
    function deactivateDocument(id) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/deactivate_document/"+id,
                    success: function (response) {
                        console.log(response);
                        if (response) {
    ...
    Swal.fire({
        title: '¿Estás seguro?',
        text: "Este usuario no podra ejecutar ninguna actividad, tampoco iniciar sesión, sin embargo todo lo realizado sera visible para los admisitradores.",
        type: 'info',
        showCancelButton: true,
        ...
        if (result.value) {
            location.href = "<?php echo base_url();?>staff/admins/delete_doctor/" + admin_id;
        }
    })
}

        ...
        <div id="sticky">
            <div class="todo-sidebar-section" style="border-bottom:0px">
                <div class="todo-sidebar-section-contents">
                    <ul class="tasks-list">
                        <li class="side-li">
                            <a class="side-items active" href="<?php echo base_url();?>staff/staff_profile/<?php echo base64_encode($staff_id);?>/"><i style="padding-right: 10px; font-size: 22px;" class="picons-thin-icon-thin-0002_write_pencil_new_edit"></i> Editar perfil <span class="side-active"></span> </a>
                        </li>
                        <li class="side-li">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="tasks-section">
                    <form action="<?php echo base_url();?>staff/staff/edit/<?php echo $details['staff_id'];?>" method="POST" enctype="multipart/form-data" id="form">
                        <div class="row">

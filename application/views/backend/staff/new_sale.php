                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-12 mb-2" id="divCash_0" style="">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <input name="cambio" id="cambio" class="form-control" type="number" step="any" onchange="findCambio()"  onkeyup="findCambio()"/>
                                                    </div>
                                                    <div class="">
...
function getPrice(product_id, variant_id) {
    ...
    }else
    {
       ...
       $.ajax({
            url: '<?php echo base_url();?>staff/get_product_price/' + product_id + '/' + insurance,
            success: function(response) {
                console.log(response);
                jQuery('#sb_' + variant_id).val(response);
                jQuery('#sb_' + variant_id).attr('readonly', true);

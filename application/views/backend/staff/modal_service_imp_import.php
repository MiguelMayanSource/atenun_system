<div class="modal-content animated fadeInDown">
    ...
    <form action="<?php echo base_url();?>staff/inventory_products/product_import/<?php echo  $param2;?>" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <a class="btn btn-info text-white btn-lg" href="<?php echo base_url();?>staff/download_example/Implementos_servicios" style="width:100%;"><i class="picons-thin-icon-thin-0123_download_cloud_file_sync"></i> Descargar formato</a>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">

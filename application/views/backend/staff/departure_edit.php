            ...
            <div class="card-box">
                <div class="card-b">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="repeater" action="<?php echo base_url();?>staff/departure/edit" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-3">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="<?php echo base_url().'staff/policy_departure/'.base64_encode($departure_id);?>" class="btn btn-secondary">Póliza(s)</a>
                                    </div>
...
<script type="text/javascript">
    ...
    $(".select2-provider-purchase").select2({
        ...
        ajax: {
            url: "<?php echo base_url();?>staff/getProviderAjax/1",
            type: "POST",
            dataType: "json",
            delay: 250,
    ...
    function searchNumDoc(i, id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>staff/countOtherExistPurchase/",
            data: {
                id: id,
                number: number
            },
    ...
    function deleteDetail(i, id, inx) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/departure_edit/deactivate_detail/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {
    ...
    function deletePurchase(i, id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/departure_edit/deactivate_purchase/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

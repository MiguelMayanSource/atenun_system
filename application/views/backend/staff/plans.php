        ...
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>staff/points';">
                        Ver</div>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="profile-tile profile-tile-inlined">
                <div class="profile-tile-box">
                    ...
                    <div class="pt-user-name" onclick="window.location.href='<?php echo base_url();?>staff/memberships';">
                        Ver</div>
                </div>
            </div>
        </div>

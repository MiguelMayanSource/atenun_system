    ...
    <div class="os-tabs-w">
        <div class="os-tabs-controls">
            <ul class="navx nav-tabs">
                ...
                <li class="nav-item text-center">
                    <a class="nav-link current" href="<?php echo base_url();?>staff/purchases/">
...
<div id="main-content">
    ...
    <form action="<?php echo base_url();?>staff/purchases/create_solicitud" method="POST">
        <div class="row">
            <div class="col-md-12">
                <div class="order-box">
                            ...
                            <div class="order-controls row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label for="">C¨®digo de orden</label>
...
function getServicesProvider(provider_id, variant_id) {
    $.ajax({
        url: '<?php echo base_url();?>staff/get_services_provider/' + provider_id,
...
function getProductsProvider(provider_id, variant_id) {
    $.ajax({
        url: '<?php echo base_url();?>staff/get_products_provider/' + provider_id,
        success: function(response) {
            console.log(response);
            if (response != "")

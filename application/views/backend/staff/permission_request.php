                ...
                <table class="table custom-table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr style="font-family:'Poppins';font-size:14px;font-weight:bold;color:#4b4a55" class="">
                            ...
                            <td>
                                <a target="_blank" href="<?php echo base_url(); ?>staff/permission_details/<?php echo $row['permission_request_id'];?>" ><i style="vertical-align:-3px;color:#a7aabb;font-size:18px;font-weight:bold;" class="picons-thin-icon-thin-0012_notebook_paper_certificate"></i></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
...
<div class="modal" id="123">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content animated fadeInDown">
            <form action="<?php echo base_url();?>staff/permission_request/create" method="POST">

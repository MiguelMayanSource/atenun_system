...
function updateIMC( _id, text) {
    
    var w = parseFloat($('.w').val())/2.2046;
    var t = (parseFloat($('.t').val())/100);
    var imc = parseFloat(w).toFixed(2)/(parseFloat(t) * parseFloat(t));
    console.log(parseFloat(w).toFixed(2),parseFloat(t),imc.toFixed(2));
    
     var imc = $('.imc').val(imc.toFixed(2)).change();
}

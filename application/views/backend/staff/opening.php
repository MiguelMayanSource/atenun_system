                ...
                <div class="card-b">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="mb-3">
                                <div class="">
                                    <a class="btn btn-info" href="<?php echo base_url();?>staff/opening_departure/">
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="<?php echo base_url()."staff/opening_detail/".base64_encode($op['reopening_id']);?>"><i class="bx bx-detail"></i></a>
                                                &nbsp;
                                                &nbsp;
    ...
    function eliminarCierre(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>staff/opening/delete/",
                    data: {
                        id: id,
                    },
                    beforeSend: function () {

...
(function ($) {
    ...
    /*=====================
      ...
      $('.msg-setting').on('click', function () {
        ...
        if(  $(this).siblings('.msg-dropdown').css('display') == "none")
            $(this).siblings('.msg-dropdown').css('display','block');
        else
        $(this).siblings('.msg-dropdown').css('display','none');
    });
    ...
    /*=====================
        ...
        $(".messages").animate({ scrollTop: $('.chatappend').height() }, "fast");
        ...
        $("#formMessage").submit(function(e) {
            ...
            $.ajax({
                   ...
                   success: function(data)
                   {
                    ...
                    $('#setemoj').val('');
                    $( "#contact-chat" ).load(window.location.href + " #contact-chat" );
    ...
    /*=====================
       ...
       $('.sticker-contain ul li').on('click', function (e) 
       {
        ...
        var message = sticker;
        var thread_code = $('#thread_code').val();
